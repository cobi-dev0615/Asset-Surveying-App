    ...
    private final class NetworkTask extends AsyncTask<String, Object, JSONObject> {
        ...
        private void handleSearchResults(JSONObject jSONObject) {
            try {
                ...
                SearchBookContentsActivity.this.headerView.setText(SearchBookContentsActivity.this.getString(R.string.msg_sbc_results) + " : " + i);
                if (i > 0) {
        ...
        private SearchBookContentsResult parseResult(JSONObject jSONObject) {
            ...
            try {
                ...
                if (z) {
                    str2 = SearchBookContentsActivity.QUOT_ENTITY_PATTERN.matcher(SearchBookContentsActivity.QUOTE_ENTITY_PATTERN.matcher(SearchBookContentsActivity.GT_ENTITY_PATTERN.matcher(SearchBookContentsActivity.LT_ENTITY_PATTERN.matcher(SearchBookContentsActivity.TAG_PATTERN.matcher(optString2).replaceAll(BuildConfig.FLAVOR)).replaceAll("<")).replaceAll(">")).replaceAll("'")).replaceAll("\"");
                } else {
                ...
                return new SearchBookContentsResult(SearchBookContentsActivity.this.getString(R.string.msg_sbc_no_page_returned), BuildConfig.FLAVOR, BuildConfig.FLAVOR, false);
            }
        }
    }
}
