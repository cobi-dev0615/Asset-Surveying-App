...
public class TimePickerDialog_OnTimeSetListenerImplementor implements IGCUserPeer, TimePickerDialog.OnTimeSetListener {
    ...
    static {
        Runtime.register("Android.App.TimePickerDialog+IOnTimeSetListenerImplementor, Mono.Android", TimePickerDialog_OnTimeSetListenerImplementor.class, __md_methods);
    }
