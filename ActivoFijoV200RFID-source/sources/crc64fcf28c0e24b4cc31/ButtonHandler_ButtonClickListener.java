...
public class ButtonHandler_ButtonClickListener implements IGCUserPeer, View.OnClickListener {
    ...
    static {
        Runtime.register("Microsoft.Maui.Handlers.ButtonHandler+ButtonClickListener, Microsoft.Maui", ButtonHandler_ButtonClickListener.class, "n_onClick:(Landroid/view/View;)V:GetOnClick_Landroid_view_View_Handler:Android.Views.View/IOnClickListenerInvoker, Mono.Android, Version=0.0.0.0, Culture=neutral, PublicKeyToken=null\n");
    }

    public ButtonHandler_ButtonClickListener() {
        if (getClass() == ButtonHandler_ButtonClickListener.class) {
            TypeManager.Activate("Microsoft.Maui.Handlers.ButtonHandler+ButtonClickListener, Microsoft.Maui", "", this, new Object[0]);
        }
    }
