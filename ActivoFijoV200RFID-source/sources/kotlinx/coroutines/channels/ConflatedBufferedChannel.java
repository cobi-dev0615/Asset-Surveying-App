...
public class ConflatedBufferedChannel<E> extends BufferedChannel<E> {
    ...
    static /* synthetic */ <E> Object send$suspendImpl(ConflatedBufferedChannel<E> conflatedBufferedChannel, E e, Continuation<? super Unit> continuation) {
        ...
        Object m2203trySendImplMj0NB7M = conflatedBufferedChannel.m2203trySendImplMj0NB7M(e, true);
        if (m2203trySendImplMj0NB7M instanceof ChannelResult.Closed) {
            ChannelResult.m2188exceptionOrNullimpl(m2203trySendImplMj0NB7M);
    ...
    static /* synthetic */ <E> Object sendBroadcast$suspendImpl(ConflatedBufferedChannel<E> conflatedBufferedChannel, E e, Continuation<? super Boolean> continuation) {
        Object m2203trySendImplMj0NB7M = conflatedBufferedChannel.m2203trySendImplMj0NB7M(e, true);
        if (!(m2203trySendImplMj0NB7M instanceof ChannelResult.Failed)) {
    ...
    public Object mo2169trySendJP2dKIU(E element) {
        return m2203trySendImplMj0NB7M(element, false);
    }

    /* renamed from: trySendImpl-Mj0NB7M, reason: not valid java name */
    private final Object m2203trySendImplMj0NB7M(E element, boolean isSendOp) {
        return this.onBufferOverflow == BufferOverflow.DROP_LATEST ? m2202trySendDropLatestMj0NB7M(element, isSendOp) : m2178trySendDropOldestJP2dKIU(element);
    }

    /* renamed from: trySendDropLatest-Mj0NB7M, reason: not valid java name */
    private final Object m2202trySendDropLatestMj0NB7M(E element, boolean isSendOp) {
        Function1<E, Unit> function1;
        UndeliveredElementException callUndeliveredElementCatchingException$default;
        Object mo2169trySendJP2dKIU = super.mo2169trySendJP2dKIU(element);
        if (ChannelResult.m2194isSuccessimpl(mo2169trySendJP2dKIU) || ChannelResult.m2192isClosedimpl(mo2169trySendJP2dKIU)) {
            return mo2169trySendJP2dKIU;
        }
    ...
    protected void registerSelectForSend(SelectInstance<?> select, Object element) {
        Object mo2169trySendJP2dKIU = mo2169trySendJP2dKIU(element);
        if (!(mo2169trySendJP2dKIU instanceof ChannelResult.Failed)) {
            select.selectInRegistrationPhase(Unit.INSTANCE);
        } else {
            if (!(mo2169trySendJP2dKIU instanceof ChannelResult.Closed)) {
                throw new IllegalStateException("unreachable".toString());
            }
            ChannelResult.m2188exceptionOrNullimpl(mo2169trySendJP2dKIU);
