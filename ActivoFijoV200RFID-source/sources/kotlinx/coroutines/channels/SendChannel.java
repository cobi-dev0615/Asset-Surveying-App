...
public interface SendChannel<E> {
    ...
    public static final class DefaultImpls {
        ...
        public static <E> boolean offer(SendChannel<? super E> sendChannel, E e) {
            Object mo2169trySendJP2dKIU = sendChannel.mo2169trySendJP2dKIU(e);
            if (ChannelResult.m2194isSuccessimpl(mo2169trySendJP2dKIU)) {
                return true;
            }
            Throwable m2188exceptionOrNullimpl = ChannelResult.m2188exceptionOrNullimpl(mo2169trySendJP2dKIU);
