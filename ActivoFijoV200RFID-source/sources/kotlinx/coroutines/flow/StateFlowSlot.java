...
final class StateFlowSlot extends AbstractSharedFlowSlot<StateFlowImpl<?>> {
    ...
    public final void makePending() {
        ...
        while (true) {
            ...
            if (value == symbol2) {
                ...
                if (PreviewView$1$$ExternalSyntheticBackportWithForwarding0.m(atomicReference2, value, symbol3)) {
                    return;
                }
            } else {
                AtomicReference<Object> atomicReference3 = this._state;
                symbol4 = StateFlowKt.NONE;
                if (PreviewView$1$$ExternalSyntheticBackportWithForwarding0.m(atomicReference3, value, symbol4)) {
                    Result.Companion companion = Result.INSTANCE;
                    ((CancellableContinuationImpl) value).resumeWith(Result.m661constructorimpl(Unit.INSTANCE));
                    return;
                }
            }
        }
    ...
    public final Object awaitPending(Continuation<? super Unit> continuation) {
        ...
        symbol = StateFlowKt.NONE;
        if (!PreviewView$1$$ExternalSyntheticBackportWithForwarding0.m(atomicReference, symbol, cancellableContinuationImpl2)) {
            ...
            Result.Companion companion = Result.INSTANCE;
            cancellableContinuationImpl2.resumeWith(Result.m661constructorimpl(Unit.INSTANCE));
        }
