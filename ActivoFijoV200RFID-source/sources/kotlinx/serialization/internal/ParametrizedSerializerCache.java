...
public interface ParametrizedSerializerCache<T> {
    ...
    Object mo2256getgIAlus(KClass<Object> key, List<? extends KType> types);
    ...
    public static final class DefaultImpls {
        ...
        public static /* synthetic */ Object m2262getgIAlus$default(ParametrizedSerializerCache parametrizedSerializerCache, KClass kClass, List list, int i, Object obj) {
            if (obj != null) {
            ...
            return parametrizedSerializerCache.mo2256getgIAlus(kClass, list);
        }
    }
}
