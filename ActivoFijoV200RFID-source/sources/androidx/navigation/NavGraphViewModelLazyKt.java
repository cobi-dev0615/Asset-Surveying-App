...
public final class NavGraphViewModelLazyKt {
    ...
    public static final NavBackStackEntry m415navGraphViewModels$lambda0(Lazy<NavBackStackEntry> lazy) {
    ...
    public static final NavBackStackEntry m416navGraphViewModels$lambda1(Lazy<NavBackStackEntry> lazy) {
        return lazy.getValue();
    }
    ...
    public static final NavBackStackEntry m417navGraphViewModels$lambda2(Lazy<NavBackStackEntry> lazy) {
        return lazy.getValue();
    }
    ...
    public static final NavBackStackEntry m418navGraphViewModels$lambda3(Lazy<NavBackStackEntry> lazy) {
        return lazy.getValue();
    }
}
