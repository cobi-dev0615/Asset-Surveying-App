    ...
    static ForwardingImageProxy downsample(ImageProxy imageProxy, int i, int i2, DownsamplingMethod downsamplingMethod) {
        ...
        for (int i7 = 3; i6 < i7; i7 = 3) {
            ...
            if (ordinal == 0) {
                ...
                i3 = 1;
                resizeAveraging(buffer, iArr[i6], planeProxy.getPixelStride(), planeProxy.getRowStride(), iArr2[i6], bArr2, iArr3[i6], iArr4[i6]);
                bArr = bArr2;
            }
            planeProxyArr[i6] = createPlaneProxy(iArr3[i6], i3, bArr);
            i6++;
        }
