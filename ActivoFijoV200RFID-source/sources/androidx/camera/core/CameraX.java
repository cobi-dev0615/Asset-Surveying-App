...
public final class CameraX {
        ...
        synchronized (this.mInitializeLock) {
            ...
            future = CallbackToFutureAdapter.getFuture(new CallbackToFutureAdapter.Resolver() { // from class: androidx.camera.core.CameraX$$ExternalSyntheticLambda3
                ...
                public final Object attachCompleter(CallbackToFutureAdapter.Completer completer) {
                    return CameraX.this.m135lambda$initInternal$0$androidxcameracoreCameraX(context, completer);
                }
            });
        }
        return future;
    ...
    /* synthetic */ Object m135lambda$initInternal$0$androidxcameracoreCameraX(Context context, CallbackToFutureAdapter.Completer completer) throws Exception {
    ...
    private void initAndRetryRecursively(final Executor executor, final long j, final int i, final Context context, final CallbackToFutureAdapter.Completer<Void> completer) {
        executor.execute(new Runnable() { // from class: androidx.camera.core.CameraX$$ExternalSyntheticLambda2
            ...
            public final void run() {
                CameraX.this.m134lambda$initAndRetryRecursively$2$androidxcameracoreCameraX(context, executor, i, completer, j);
            }
        });
    }
    ...
    */
    /* synthetic */ void m134lambda$initAndRetryRecursively$2$androidxcameracoreCameraX(android.content.Context r19, final java.util.concurrent.Executor r20, final int r21, final androidx.concurrent.futures.CallbackToFutureAdapter.Completer r22, final long r23) {
        /*
            Method dump skipped, instructions count: 376
            To view this dump add '--comments-level debug' option
        */
        throw new UnsupportedOperationException("Method not decompiled: androidx.camera.core.CameraX.m134lambda$initAndRetryRecursively$2$androidxcameracoreCameraX(android.content.Context, java.util.concurrent.Executor, int, androidx.concurrent.futures.CallbackToFutureAdapter$Completer, long):void");
    }

    /* renamed from: lambda$initAndRetryRecursively$1$androidx-camera-core-CameraX, reason: not valid java name */
    /* synthetic */ void m133lambda$initAndRetryRecursively$1$androidxcameracoreCameraX(Executor executor, long j, int i, Context context, CallbackToFutureAdapter.Completer completer) {
        ...
        synchronized (this.mInitializeLock) {
            ...
            if (ordinal == 2 || ordinal == 3) {
                ...
                this.mShutdownInternalFuture = CallbackToFutureAdapter.getFuture(new CallbackToFutureAdapter.Resolver() { // from class: androidx.camera.core.CameraX$$ExternalSyntheticLambda4
                    @Override // androidx.concurrent.futures.CallbackToFutureAdapter.Resolver
                    public final Object attachCompleter(CallbackToFutureAdapter.Completer completer) {
                        return CameraX.this.m137lambda$shutdownInternal$4$androidxcameracoreCameraX(completer);
                    }
                });
            }
    ...
    /* synthetic */ Object m137lambda$shutdownInternal$4$androidxcameracoreCameraX(final CallbackToFutureAdapter.Completer completer) throws Exception {
        this.mCameraRepository.deinit().addListener(new Runnable() { // from class: androidx.camera.core.CameraX$$ExternalSyntheticLambda0
            @Override // java.lang.Runnable
            public final void run() {
                CameraX.this.m136lambda$shutdownInternal$3$androidxcameracoreCameraX(completer);
            }
    ...
    /* synthetic */ void m136lambda$shutdownInternal$3$androidxcameracoreCameraX(CallbackToFutureAdapter.Completer completer) {
