...
public final class VideoCapture<T extends VideoOutput> extends UseCase {
        ...
        this.mStreamInfoObserver = new Observable.Observer<StreamInfo>() { // from class: androidx.camera.video.VideoCapture.1
            ...
            public void onNewData(StreamInfo streamInfo) {
                ...
                if ((streamInfo2.getId() != -1 && streamInfo.getId() == -1) || (streamInfo2.getId() == -1 && streamInfo.getId() != -1)) {
                    ...
                    m2 = UByte$$ExternalSyntheticBackport0.m(new Object[]{videoCapture2.mSessionConfigBuilder.build()});
                ...
                if (streamInfo2.getStreamState() != streamInfo.getStreamState()) {
                    ...
                    m = UByte$$ExternalSyntheticBackport0.m(new Object[]{videoCapture4.mSessionConfigBuilder.build()});
    ...
    private SessionConfig.Builder createPipeline(final VideoCaptureConfig<T> videoCaptureConfig, StreamSpec streamSpec) {
        ...
        if (this.mNode != null) {
            ...
            surfaceEdge2.addOnInvalidatedListener(new Runnable() { // from class: androidx.camera.video.VideoCapture$$ExternalSyntheticLambda4
                @Override // java.lang.Runnable
                public final void run() {
                    VideoCapture.this.m239lambda$createPipeline$1$androidxcameravideoVideoCapture(surfaceEdge2, cameraInternal, videoCaptureConfig, resolveTimebase);
                }
            });
            ...
            deferrableSurface.getTerminationFuture().addListener(new Runnable() { // from class: androidx.camera.video.VideoCapture$$ExternalSyntheticLambda5
                @Override // java.lang.Runnable
                public final void run() {
                    VideoCapture.this.m240lambda$createPipeline$2$androidxcameravideoVideoCapture(deferrableSurface);
                }
        ...
        SessionConfig.CloseableErrorListener closeableErrorListener2 = new SessionConfig.CloseableErrorListener(new SessionConfig.ErrorListener() { // from class: androidx.camera.video.VideoCapture$$ExternalSyntheticLambda6
            @Override // androidx.camera.core.impl.SessionConfig.ErrorListener
            public final void onError(SessionConfig sessionConfig, SessionConfig.SessionError sessionError) {
                VideoCapture.this.m241lambda$createPipeline$3$androidxcameravideoVideoCapture(sessionConfig, sessionError);
            }
        });
    ...
    /* synthetic */ void m240lambda$createPipeline$2$androidxcameravideoVideoCapture(DeferrableSurface deferrableSurface) {
    ...
    /* synthetic */ void m241lambda$createPipeline$3$androidxcameravideoVideoCapture(SessionConfig sessionConfig, SessionConfig.SessionError sessionError) {
        resetPipeline();
    }

    /* JADX INFO: Access modifiers changed from: private */
    /* renamed from: onAppEdgeInvalidated, reason: merged with bridge method [inline-methods] */
    public void m239lambda$createPipeline$1$androidxcameravideoVideoCapture(SurfaceEdge surfaceEdge, CameraInternal cameraInternal, VideoCaptureConfig<T> videoCaptureConfig, Timebase timebase) {
        ...
        static {
            VideoOutput videoOutput = new VideoOutput() { // from class: androidx.camera.video.VideoCapture$Defaults$$ExternalSyntheticLambda0
                ...
                public /* synthetic */ VideoCapabilities getMediaCapabilities(CameraInfo cameraInfo) {
                    ...
                    videoCapabilities = VideoCapabilities.EMPTY;
                ...
                public /* synthetic */ Observable isSourceStreamRequired() {
                    Observable withValue;
                    withValue = ConstantObservable.withValue(false);
                    return withValue;
                }
    ...
    private static Rect adjustCropRectToValidSize(final Rect rect, Size size, VideoEncoderInfo videoEncoderInfo) {
        ...
        Collections.sort(arrayList, new Comparator() { // from class: androidx.camera.video.VideoCapture$$ExternalSyntheticLambda8
    ...
    private static boolean shouldEnableSurfaceProcessingByQuirk(CameraInternal cameraInternal) {
        return cameraInternal.getHasTransform() && (SurfaceProcessingQuirk.CC.workaroundBySurfaceProcessing(DeviceQuirks.getAll()) || SurfaceProcessingQuirk.CC.workaroundBySurfaceProcessing(cameraInternal.getCameraInfoInternal().getCameraQuirks()));
    }
    ...
    private void setupSurfaceUpdateNotifier(final SessionConfig.Builder builder, final boolean z) {
        ...
        final ListenableFuture<Void> future = CallbackToFutureAdapter.getFuture(new CallbackToFutureAdapter.Resolver() { // from class: androidx.camera.video.VideoCapture$$ExternalSyntheticLambda9
            @Override // androidx.concurrent.futures.CallbackToFutureAdapter.Resolver
            public final Object attachCompleter(CallbackToFutureAdapter.Completer completer) {
                return VideoCapture.this.m242xc7537f7(builder, completer);
            }
        });
    ...
    /* synthetic */ Object m242xc7537f7(final SessionConfig.Builder builder, CallbackToFutureAdapter.Completer completer) throws Exception {
        ...
        completer.addCancellationListener(new Runnable() { // from class: androidx.camera.video.VideoCapture$$ExternalSyntheticLambda7
            @Override // java.lang.Runnable
            public final void run() {
    ...
    class AnonymousClass2 extends CameraCaptureCallback {
        ...
        public void onCaptureCompleted(int i, CameraCaptureResult cameraCaptureResult) {
            ...
            mainThreadExecutor.execute(new Runnable() { // from class: androidx.camera.video.VideoCapture$2$$ExternalSyntheticLambda0
                @Override // java.lang.Runnable
                public final void run() {
                    VideoCapture.AnonymousClass2.this.m243lambda$onCaptureCompleted$0$androidxcameravideoVideoCapture$2(builder);
                }
            });
        }

        /* renamed from: lambda$onCaptureCompleted$0$androidx-camera-video-VideoCapture$2, reason: not valid java name */
        /* synthetic */ void m243lambda$onCaptureCompleted$0$androidxcameravideoVideoCapture$2(SessionConfig.Builder builder) {
    ...
    private static List<Size> filterOutEncoderUnsupportedResolutions(VideoCaptureConfig<?> videoCaptureConfig, MediaSpec mediaSpec, DynamicRange dynamicRange, VideoCapabilities videoCapabilities, List<Size> list, Map<Quality, Size> map) {
        ...
        VideoEncoderInfo findLargestSupportedSizeVideoEncoderInfo;
        if (list.isEmpty()) {
            return list;
        }
        ...
        while (it.hasNext()) {
            Size next = it.next();
            if (!map.containsValue(next) && (findNearestHigherSupportedEncoderProfilesFor = videoCapabilities.findNearestHigherSupportedEncoderProfilesFor(next, dynamicRange)) != null && (findLargestSupportedSizeVideoEncoderInfo = findLargestSupportedSizeVideoEncoderInfo(videoCaptureConfig.getVideoEncoderInfoFinder(), findNearestHigherSupportedEncoderProfilesFor, dynamicRange, mediaSpec, next, (Range) Objects.requireNonNull(videoCaptureConfig.getTargetFrameRate(Defaults.DEFAULT_FPS_RANGE)))) != null && !findLargestSupportedSizeVideoEncoderInfo.isSizeSupportedAllowSwapping(next.getWidth(), next.getHeight())) {
                it.remove();
            }
        }
        return list;
