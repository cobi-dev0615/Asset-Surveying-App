...
final class Camera2CameraImpl implements CameraInternal {
    ...
    public void configAndCloseIfNeeded() {
        ...
        if (!this.mCameraAvailability.isCameraAvailable()) {
            ...
            openCameraConfigAndClose.addListener(new Runnable() { // from class: androidx.camera.camera2.internal.Camera2CameraImpl$$ExternalSyntheticLambda3
                @Override // java.lang.Runnable
                public final void run() {
                    Camera2CameraImpl.this.m22x65edacec();
                }
            }, this.mExecutor);
        }
    }
    ...
    private ListenableFuture<Void> openCameraConfigAndClose() {
        return CallbackToFutureAdapter.getFuture(new CallbackToFutureAdapter.Resolver() { // from class: androidx.camera.camera2.internal.Camera2CameraImpl$$ExternalSyntheticLambda2
            ...
            public final Object attachCompleter(CallbackToFutureAdapter.Completer completer) {
                return Camera2CameraImpl.this.m32xfb055f0e(completer);
            }
        });
    }
    ...
    /* synthetic */ Object m32xfb055f0e(final CallbackToFutureAdapter.Completer completer) throws Exception {
        try {
    ...
    public ListenableFuture<Void> configAndClose(CameraDevice cameraDevice) {
        ...
        immediateSurface.getTerminationFuture().addListener(new Runnable() { // from class: androidx.camera.camera2.internal.Camera2CameraImpl$$ExternalSyntheticLambda19
            @Override // java.lang.Runnable
            public final void run() {
        ...
        return FutureChain.from(Futures.transformAsyncOnCompletion(captureSession.open(builder.build(), cameraDevice, this.mCaptureSessionOpenerBuilder.build()))).transformAsync(new AsyncFunction() { // from class: androidx.camera.camera2.internal.Camera2CameraImpl$$ExternalSyntheticLambda20
    ...
    public ListenableFuture<Void> release() {
        return CallbackToFutureAdapter.getFuture(new CallbackToFutureAdapter.Resolver() { // from class: androidx.camera.camera2.internal.Camera2CameraImpl$$ExternalSyntheticLambda10
            @Override // androidx.concurrent.futures.CallbackToFutureAdapter.Resolver
            public final Object attachCompleter(CallbackToFutureAdapter.Completer completer) {
                return Camera2CameraImpl.this.m34x22c7252f(completer);
            }
        });
    }

    /* renamed from: lambda$release$5$androidx-camera-camera2-internal-Camera2CameraImpl, reason: not valid java name */
    /* synthetic */ Object m34x22c7252f(final CallbackToFutureAdapter.Completer completer) throws Exception {
        this.mExecutor.execute(new Runnable() { // from class: androidx.camera.camera2.internal.Camera2CameraImpl$$ExternalSyntheticLambda18
            @Override // java.lang.Runnable
            public final void run() {
                Camera2CameraImpl.this.m33xf4ee8ad0(completer);
            }
        });
    ...
    /* synthetic */ void m33xf4ee8ad0(CallbackToFutureAdapter.Completer completer) {
        ...
        if (this.mUserReleaseFuture == null) {
            if (this.mState != InternalState.RELEASED) {
                this.mUserReleaseFuture = CallbackToFutureAdapter.getFuture(new CallbackToFutureAdapter.Resolver() { // from class: androidx.camera.camera2.internal.Camera2CameraImpl$$ExternalSyntheticLambda14
                    @Override // androidx.concurrent.futures.CallbackToFutureAdapter.Resolver
                    public final Object attachCompleter(CallbackToFutureAdapter.Completer completer) {
                        return Camera2CameraImpl.this.m24x9e399b31(completer);
                    }
                });
            } else {
    ...
    /* synthetic */ Object m24x9e399b31(CallbackToFutureAdapter.Completer completer) throws Exception {
    ...
    public void onUseCaseActive(UseCase useCase) {
        ...
        this.mExecutor.execute(new Runnable() { // from class: androidx.camera.camera2.internal.Camera2CameraImpl$$ExternalSyntheticLambda9
            @Override // java.lang.Runnable
            public final void run() {
                Camera2CameraImpl.this.m29x4ba3b9b6(useCaseId, sessionConfig, currentConfig, attachedStreamSpec, captureTypes);
            }
        });
    }

    /* renamed from: lambda$onUseCaseActive$7$androidx-camera-camera2-internal-Camera2CameraImpl, reason: not valid java name */
    /* synthetic */ void m29x4ba3b9b6(String str, SessionConfig sessionConfig, UseCaseConfig useCaseConfig, StreamSpec streamSpec, List list) {
    ...
    public void onUseCaseUpdated(UseCase useCase) {
        ...
        this.mExecutor.execute(new Runnable() { // from class: androidx.camera.camera2.internal.Camera2CameraImpl$$ExternalSyntheticLambda7
            @Override // java.lang.Runnable
            public final void run() {
                Camera2CameraImpl.this.m31x44486635(useCaseId, sessionConfig, currentConfig, attachedStreamSpec, captureTypes);
            }
        });
    }

    /* renamed from: lambda$onUseCaseUpdated$9$androidx-camera-camera2-internal-Camera2CameraImpl, reason: not valid java name */
    /* synthetic */ void m31x44486635(String str, SessionConfig sessionConfig, UseCaseConfig useCaseConfig, StreamSpec streamSpec, List list) {
    ...
    private void resetUseCase(final String str, final SessionConfig sessionConfig, final UseCaseConfig<?> useCaseConfig, final StreamSpec streamSpec, final List<UseCaseConfigFactory.CaptureType> list) {
        this.mExecutor.execute(new Runnable() { // from class: androidx.camera.camera2.internal.Camera2CameraImpl$$ExternalSyntheticLambda16
            @Override // java.lang.Runnable
            public final void run() {
                Camera2CameraImpl.this.m35xb3c15a2c(str, sessionConfig, useCaseConfig, streamSpec, list);
            }
        });
    }

    /* renamed from: lambda$resetUseCase$10$androidx-camera-camera2-internal-Camera2CameraImpl, reason: not valid java name */
    /* synthetic */ void m35xb3c15a2c(String str, SessionConfig sessionConfig, UseCaseConfig useCaseConfig, StreamSpec streamSpec, List list) {
    ...
    boolean isUseCaseAttached(UseCase useCase) {
        try {
            ...
            return ((Boolean) CallbackToFutureAdapter.getFuture(new CallbackToFutureAdapter.Resolver() { // from class: androidx.camera.camera2.internal.Camera2CameraImpl$$ExternalSyntheticLambda13
                @Override // androidx.concurrent.futures.CallbackToFutureAdapter.Resolver
                public final Object attachCompleter(CallbackToFutureAdapter.Completer completer) {
                    return Camera2CameraImpl.this.m28xf78c78d9(useCaseId, completer);
                }
            }).get()).booleanValue();
    ...
    /* synthetic */ Object m28xf78c78d9(final String str, final CallbackToFutureAdapter.Completer completer) throws Exception {
        try {
            this.mExecutor.execute(new Runnable() { // from class: androidx.camera.camera2.internal.Camera2CameraImpl$$ExternalSyntheticLambda0
                @Override // java.lang.Runnable
                public final void run() {
                    Camera2CameraImpl.this.m27xc9b3de7a(completer, str);
                }
            });
    ...
    /* synthetic */ void m27xc9b3de7a(CallbackToFutureAdapter.Completer completer, String str) {
    ...
    boolean isMeteringRepeatingAttached() {
        try {
            return ((Boolean) CallbackToFutureAdapter.getFuture(new CallbackToFutureAdapter.Resolver() { // from class: androidx.camera.camera2.internal.Camera2CameraImpl$$ExternalSyntheticLambda6
                @Override // androidx.concurrent.futures.CallbackToFutureAdapter.Resolver
                public final Object attachCompleter(CallbackToFutureAdapter.Completer completer) {
                    return Camera2CameraImpl.this.m26x3a89a76e(completer);
                }
            }).get()).booleanValue();
        } catch (InterruptedException | ExecutionException e) {
    ...
    /* synthetic */ Object m26x3a89a76e(final CallbackToFutureAdapter.Completer completer) throws Exception {
        try {
            this.mExecutor.execute(new Runnable() { // from class: androidx.camera.camera2.internal.Camera2CameraImpl$$ExternalSyntheticLambda21
                @Override // java.lang.Runnable
                public final void run() {
                    Camera2CameraImpl.this.m25xcb10d0f(completer);
                }
            });
    ...
    /* synthetic */ void m25xcb10d0f(CallbackToFutureAdapter.Completer completer) {
    ...
    public void attachUseCases(Collection<UseCase> collection) {
        ...
        try {
            this.mExecutor.execute(new Runnable() { // from class: androidx.camera.camera2.internal.Camera2CameraImpl$$ExternalSyntheticLambda5
                @Override // java.lang.Runnable
                public final void run() {
                    Camera2CameraImpl.this.m21x1cf87860(arrayList2);
                }
            });
    ...
    /* synthetic */ void m21x1cf87860(List list) {
        try {
    ...
    public void detachUseCases(Collection<UseCase> collection) {
        ...
        this.mExecutor.execute(new Runnable() { // from class: androidx.camera.camera2.internal.Camera2CameraImpl$$ExternalSyntheticLambda15
            @Override // java.lang.Runnable
            public final void run() {
                Camera2CameraImpl.this.m23x3fc4c78d(arrayList2);
            }
        });
    }
    ...
    public void m23x3fc4c78d(Collection<UseCaseInfo> collection) {
        ArrayList arrayList = new ArrayList();
        boolean z = false;
        for (UseCaseInfo useCaseInfo : collection) {
            if (this.mUseCaseAttachState.isUseCaseAttached(useCaseInfo.getUseCaseId())) {
    ...
    private void addOrRemoveMeteringRepeatingUseCase() {
        ...
        if (repeatingCaptureConfig.getSurfaces().isEmpty()) {
            if (this.mMeteringRepeatingSession == null) {
                this.mMeteringRepeatingSession = new MeteringRepeatingSession(this.mCameraInfoInternal.getCameraCharacteristicsCompat(), this.mDisplayInfoManager, new MeteringRepeatingSession.SurfaceResetCallback() { // from class: androidx.camera.camera2.internal.Camera2CameraImpl$$ExternalSyntheticLambda12
                    @Override // androidx.camera.camera2.internal.MeteringRepeatingSession.SurfaceResetCallback
                    public final void onSurfaceReset() {
                        Camera2CameraImpl.this.m20x8e086554();
                    }
                });
            }
    ...
    public void setActiveResumingMode(final boolean z) {
        this.mExecutor.execute(new Runnable() { // from class: androidx.camera.camera2.internal.Camera2CameraImpl$$ExternalSyntheticLambda17
            @Override // java.lang.Runnable
            public final void run() {
                Camera2CameraImpl.this.m36x83557197(z);
            }
        });
    }
    ...
    /* synthetic */ void m36x83557197(boolean z) {
    ...
    void postSurfaceClosedError(final SessionConfig sessionConfig) {
        ...
        if (errorListener != null) {
            ...
            mainThreadExecutor.execute(new Runnable() { // from class: androidx.camera.camera2.internal.Camera2CameraImpl$$ExternalSyntheticLambda11
                @Override // java.lang.Runnable
                public final void run() {
        ...
        class ScheduledReopen implements Runnable {
            ...
            public void run() {
                this.mExecutor.execute(new Runnable() { // from class: androidx.camera.camera2.internal.Camera2CameraImpl$StateCallback$ScheduledReopen$$ExternalSyntheticLambda0
                    @Override // java.lang.Runnable
                    public final void run() {
                        Camera2CameraImpl.StateCallback.ScheduledReopen.this.m38x10b58748();
                    }
                });
            }
