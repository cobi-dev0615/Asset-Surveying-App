...
class Camera2CapturePipeline {
    ...
    static class CameraCapturePipelineImpl implements CameraCapturePipeline {
        ...
        public ListenableFuture<Void> invokePostCapture() {
            return CallbackToFutureAdapter.getFuture(new CallbackToFutureAdapter.Resolver() { // from class: androidx.camera.camera2.internal.Camera2CapturePipeline$CameraCapturePipelineImpl$$ExternalSyntheticLambda0
                ...
                public final Object attachCompleter(CallbackToFutureAdapter.Completer completer) {
                    return Camera2CapturePipeline.CameraCapturePipelineImpl.this.m40x44fc0440(completer);
                }
            });
        }
        ...
        /* synthetic */ Object m40x44fc0440(CallbackToFutureAdapter.Completer completer) throws Exception {
    ...
    static class Pipeline {
        ...
        ListenableFuture<List<Void>> executeCapture(final List<CaptureConfig> list, final int i) {
            FutureChain transformAsync = FutureChain.from(executePreCapture(i)).transformAsync(new AsyncFunction() { // from class: androidx.camera.camera2.internal.Camera2CapturePipeline$Pipeline$$ExternalSyntheticLambda1
                @Override // androidx.camera.core.impl.utils.futures.AsyncFunction
                public final ListenableFuture apply(Object obj) {
                    return Camera2CapturePipeline.Pipeline.this.m41xe4aaa129(list, i, (TotalCaptureResult) obj);
                }
            }, this.mExecutor);
            transformAsync.addListener(new Runnable() { // from class: androidx.camera.camera2.internal.Camera2CapturePipeline$Pipeline$$ExternalSyntheticLambda2
        ...
        /* synthetic */ ListenableFuture m41xe4aaa129(List list, int i, TotalCaptureResult totalCaptureResult) throws Exception {
        ...
        public ListenableFuture<TotalCaptureResult> executePreCapture(final int i) {
            ...
            return FutureChain.from(this.mPipelineSubTask.isCaptureResultNeeded() ? Camera2CapturePipeline.waitForResult(this.mCameraControl, null) : Futures.immediateFuture(null)).transformAsync(new AsyncFunction() { // from class: androidx.camera.camera2.internal.Camera2CapturePipeline$Pipeline$$ExternalSyntheticLambda3
                @Override // androidx.camera.core.impl.utils.futures.AsyncFunction
                public final ListenableFuture apply(Object obj) {
                    return Camera2CapturePipeline.Pipeline.this.m42xc852b1db(i, (TotalCaptureResult) obj);
                }
                ...
                @Override // androidx.camera.core.impl.utils.futures.AsyncFunction
                public final ListenableFuture apply(Object obj) {
                    return Camera2CapturePipeline.Pipeline.this.m43x9cb1c219((Boolean) obj);
                }
            }, this.mExecutor);
        }
        ...
        /* synthetic */ ListenableFuture m42xc852b1db(int i, TotalCaptureResult totalCaptureResult) throws Exception {
        ...
        /* synthetic */ ListenableFuture m43x9cb1c219(Boolean bool) throws Exception {
        ...
        ListenableFuture<List<Void>> submitConfigsInternal(List<CaptureConfig> list, int i) {
            ...
            for (CaptureConfig captureConfig : list) {
                ...
                arrayList.add(CallbackToFutureAdapter.getFuture(new CallbackToFutureAdapter.Resolver() { // from class: androidx.camera.camera2.internal.Camera2CapturePipeline$Pipeline$$ExternalSyntheticLambda0
                    @Override // androidx.concurrent.futures.CallbackToFutureAdapter.Resolver
                    public final Object attachCompleter(CallbackToFutureAdapter.Completer completer) {
                        return Camera2CapturePipeline.Pipeline.this.m44x1f41775a(from, completer);
                    }
                }));
        ...
        /* synthetic */ Object m44x1f41775a(CaptureConfig.Builder builder, final CallbackToFutureAdapter.Completer completer) throws Exception {
    ...
    static class TorchTask implements PipelineTask {
            ...
            if (Camera2CapturePipeline.isFlashRequired(this.mFlashMode, totalCaptureResult)) {
                if (this.mCameraControl.isTorchOn()) {
                    ...
                    return FutureChain.from(CallbackToFutureAdapter.getFuture(new CallbackToFutureAdapter.Resolver() { // from class: androidx.camera.camera2.internal.Camera2CapturePipeline$TorchTask$$ExternalSyntheticLambda1
                        @Override // androidx.concurrent.futures.CallbackToFutureAdapter.Resolver
                        public final Object attachCompleter(CallbackToFutureAdapter.Completer completer) {
                            return Camera2CapturePipeline.TorchTask.this.m54x3ebf0c8c(completer);
                        }
                        ...
                        @Override // androidx.camera.core.impl.utils.futures.AsyncFunction
                        public final ListenableFuture apply(Object obj) {
                            return Camera2CapturePipeline.TorchTask.this.m55x1a80884d((Void) obj);
                        }
                        ...
                        @Override // androidx.camera.core.impl.utils.futures.AsyncFunction
                        public final ListenableFuture apply(Object obj) {
                            return Camera2CapturePipeline.TorchTask.this.m56xd2037fcf((Void) obj);
                        }
        ...
        /* synthetic */ Object m54x3ebf0c8c(CallbackToFutureAdapter.Completer completer) throws Exception {
            this.mCameraControl.getTorchControl().m91xbd10d892(completer, true);
            return "TorchOn";
        }
        ...
        /* synthetic */ ListenableFuture m55x1a80884d(Void r1) throws Exception {
        ...
        /* synthetic */ ListenableFuture m56xd2037fcf(Void r5) throws Exception {
        ...
        public void postCapture() {
            if (this.mIsExecuted) {
                this.mCameraControl.getTorchControl().m91xbd10d892(null, false);
    ...
    static class AePreCaptureTask implements PipelineTask {
        ...
        public ListenableFuture<Boolean> preCapture(TotalCaptureResult totalCaptureResult) {
            if (Camera2CapturePipeline.isFlashRequired(this.mFlashMode, totalCaptureResult)) {
                ...
                return FutureChain.from(CallbackToFutureAdapter.getFuture(new CallbackToFutureAdapter.Resolver() { // from class: androidx.camera.camera2.internal.Camera2CapturePipeline$AePreCaptureTask$$ExternalSyntheticLambda0
                    @Override // androidx.concurrent.futures.CallbackToFutureAdapter.Resolver
                    public final Object attachCompleter(CallbackToFutureAdapter.Completer completer) {
                        return Camera2CapturePipeline.AePreCaptureTask.this.m39x78c3ed41(completer);
                    }
        ...
        /* synthetic */ Object m39x78c3ed41(CallbackToFutureAdapter.Completer completer) throws Exception {
            this.mCameraControl.getFocusMeteringControl().m76xcc3739a4(completer);
    ...
    static class ScreenFlashTask implements PipelineTask {
        ...
        public ListenableFuture<Boolean> preCapture(TotalCaptureResult totalCaptureResult) {
            ...
            final ListenableFuture future = CallbackToFutureAdapter.getFuture(new CallbackToFutureAdapter.Resolver() { // from class: androidx.camera.camera2.internal.Camera2CapturePipeline$ScreenFlashTask$$ExternalSyntheticLambda4
                @Override // androidx.concurrent.futures.CallbackToFutureAdapter.Resolver
                public final Object attachCompleter(CallbackToFutureAdapter.Completer completer) {
                    return Camera2CapturePipeline.ScreenFlashTask.lambda$preCapture$1(atomicReference, completer);
                }
            });
            return FutureChain.from(CallbackToFutureAdapter.getFuture(new CallbackToFutureAdapter.Resolver() { // from class: androidx.camera.camera2.internal.Camera2CapturePipeline$ScreenFlashTask$$ExternalSyntheticLambda5
                @Override // androidx.concurrent.futures.CallbackToFutureAdapter.Resolver
                public final Object attachCompleter(CallbackToFutureAdapter.Completer completer) {
                    return Camera2CapturePipeline.ScreenFlashTask.this.m48x6ffc4037(atomicReference, completer);
                }
            })).transformAsync(new AsyncFunction() { // from class: androidx.camera.camera2.internal.Camera2CapturePipeline$ScreenFlashTask$$ExternalSyntheticLambda6
                @Override // androidx.camera.core.impl.utils.futures.AsyncFunction
                public final ListenableFuture apply(Object obj) {
                    return Camera2CapturePipeline.ScreenFlashTask.this.m49x37082738((Void) obj);
                }
                ...
                @Override // androidx.camera.core.impl.utils.futures.AsyncFunction
                public final ListenableFuture apply(Object obj) {
                    return Camera2CapturePipeline.ScreenFlashTask.this.m51xc51ff53a((Void) obj);
                }
                ...
                @Override // androidx.camera.core.impl.utils.futures.AsyncFunction
                public final ListenableFuture apply(Object obj) {
                    return Camera2CapturePipeline.ScreenFlashTask.this.m52x8c2bdc3b(future, obj);
                }
                ...
                @Override // androidx.camera.core.impl.utils.futures.AsyncFunction
                public final ListenableFuture apply(Object obj) {
                    return Camera2CapturePipeline.ScreenFlashTask.this.m53x5337c33c((Void) obj);
                }
                ...
                @Override // androidx.camera.core.impl.utils.futures.AsyncFunction
                public final ListenableFuture apply(Object obj) {
                    return Camera2CapturePipeline.ScreenFlashTask.this.m46x8e5210ab((Void) obj);
                }
            }, this.mExecutor).transform(new Function() { // from class: androidx.camera.camera2.internal.Camera2CapturePipeline$ScreenFlashTask$$ExternalSyntheticLambda11
                @Override // androidx.arch.core.util.Function
                public final Object apply(Object obj) {
        ...
        /* synthetic */ Object m48x6ffc4037(final AtomicReference atomicReference, final CallbackToFutureAdapter.Completer completer) throws Exception {
            CameraXExecutors.mainThreadExecutor().execute(new Runnable() { // from class: androidx.camera.camera2.internal.Camera2CapturePipeline$ScreenFlashTask$$ExternalSyntheticLambda1
                @Override // java.lang.Runnable
                public final void run() {
                    Camera2CapturePipeline.ScreenFlashTask.this.m47xa8f05936(atomicReference, completer);
                }
            });
        ...
        /* synthetic */ void m47xa8f05936(AtomicReference atomicReference, CallbackToFutureAdapter.Completer completer) {
        ...
        /* synthetic */ ListenableFuture m49x37082738(Void r2) throws Exception {
        ...
        /* synthetic */ ListenableFuture m51xc51ff53a(Void r1) throws Exception {
            return CallbackToFutureAdapter.getFuture(new CallbackToFutureAdapter.Resolver() { // from class: androidx.camera.camera2.internal.Camera2CapturePipeline$ScreenFlashTask$$ExternalSyntheticLambda0
                @Override // androidx.concurrent.futures.CallbackToFutureAdapter.Resolver
                public final Object attachCompleter(CallbackToFutureAdapter.Completer completer) {
                    return Camera2CapturePipeline.ScreenFlashTask.this.m50xfe140e39(completer);
                }
            });
        }
        ...
        /* synthetic */ Object m50xfe140e39(CallbackToFutureAdapter.Completer completer) throws Exception {
        ...
        /* synthetic */ ListenableFuture m52x8c2bdc3b(ListenableFuture listenableFuture, Object obj) throws Exception {
        ...
        /* synthetic */ ListenableFuture m53x5337c33c(Void r1) throws Exception {
            return this.mCameraControl.getFocusMeteringControl().triggerAePrecapture();
        }
        ...
        /* synthetic */ ListenableFuture m46x8e5210ab(Void r5) throws Exception {
            return Camera2CapturePipeline.waitForResult(CHECK_3A_WITH_SCREEN_FLASH_TIMEOUT_IN_NS, this.mScheduler, this.mCameraControl, new ResultListener.Checker() { // from class: androidx.camera.camera2.internal.Camera2CapturePipeline$ScreenFlashTask$$ExternalSyntheticLambda2
                @Override // androidx.camera.camera2.internal.Camera2CapturePipeline.ResultListener.Checker
                public final boolean check(TotalCaptureResult totalCaptureResult) {
                    boolean is3AConverged;
                    is3AConverged = Camera2CapturePipeline.is3AConverged(totalCaptureResult, false);
        ...
        public void postCapture() {
            ...
            this.mCameraControl.getFocusMeteringControl().enableExternalFlashAeMode(false).addListener(new Runnable() { // from class: androidx.camera.camera2.internal.Camera2CapturePipeline$ScreenFlashTask$$ExternalSyntheticLambda12
                @Override // java.lang.Runnable
                public final void run() {
    ...
    static class ResultListener implements Camera2CameraControlImpl.CaptureResultListener {
        ...
        private final ListenableFuture<TotalCaptureResult> mFuture = CallbackToFutureAdapter.getFuture(new CallbackToFutureAdapter.Resolver() { // from class: androidx.camera.camera2.internal.Camera2CapturePipeline$ResultListener$$ExternalSyntheticLambda0
            @Override // androidx.concurrent.futures.CallbackToFutureAdapter.Resolver
            public final Object attachCompleter(CallbackToFutureAdapter.Completer completer) {
                return Camera2CapturePipeline.ResultListener.this.m45xaa6bbe23(completer);
            }
        });
        ...
        /* synthetic */ Object m45xaa6bbe23(CallbackToFutureAdapter.Completer completer) throws Exception {
