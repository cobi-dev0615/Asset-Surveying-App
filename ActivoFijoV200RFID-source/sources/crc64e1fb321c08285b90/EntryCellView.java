...
public class EntryCellView extends LinearLayout implements IGCUserPeer, TextWatcher, NoCopySpan, View.OnFocusChangeListener, TextView.OnEditorActionListener {
    ...
    static {
        Runtime.register("Microsoft.Maui.Controls.Handlers.Compatibility.EntryCellView, Microsoft.Maui.Controls", EntryCellView.class, __md_methods);
    }

    public EntryCellView(Context context, AttributeSet attributeSet, int i) {
        super(context, attributeSet, i);
        if (getClass() == EntryCellView.class) {
            TypeManager.Activate("Microsoft.Maui.Controls.Handlers.Compatibility.EntryCellView, Microsoft.Maui.Controls", "Android.Content.Context, Mono.Android:Android.Util.IAttributeSet, Mono.Android:System.Int32, System.Private.CoreLib", this, new Object[]{context, attributeSet, Integer.valueOf(i)});
        }
    }
    ...
    public EntryCellView(Context context, AttributeSet attributeSet) {
        ...
        if (getClass() == EntryCellView.class) {
            TypeManager.Activate("Microsoft.Maui.Controls.Handlers.Compatibility.EntryCellView, Microsoft.Maui.Controls", "Android.Content.Context, Mono.Android:Android.Util.IAttributeSet, Mono.Android", this, new Object[]{context, attributeSet});
        }
    }
    ...
    public EntryCellView(Context context) {
        super(context);
        if (getClass() == EntryCellView.class) {
            TypeManager.Activate("Microsoft.Maui.Controls.Handlers.Compatibility.EntryCellView, Microsoft.Maui.Controls", "Android.Content.Context, Mono.Android", this, new Object[]{context});
        }
    }
