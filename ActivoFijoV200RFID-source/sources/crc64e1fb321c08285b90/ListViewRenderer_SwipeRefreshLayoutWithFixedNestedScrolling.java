...
public class ListViewRenderer_SwipeRefreshLayoutWithFixedNestedScrolling extends SwipeRefreshLayout implements IGCUserPeer {
    ...
    static {
        Runtime.register("Microsoft.Maui.Controls.Handlers.Compatibility.ListViewRenderer+SwipeRefreshLayoutWithFixedNestedScrolling, Microsoft.Maui.Controls", ListViewRenderer_SwipeRefreshLayoutWithFixedNestedScrolling.class, __md_methods);
    }
    ...
    public ListViewRenderer_SwipeRefreshLayoutWithFixedNestedScrolling(Context context) {
        ...
        if (getClass() == ListViewRenderer_SwipeRefreshLayoutWithFixedNestedScrolling.class) {
            TypeManager.Activate("Microsoft.Maui.Controls.Handlers.Compatibility.ListViewRenderer+SwipeRefreshLayoutWithFixedNestedScrolling, Microsoft.Maui.Controls", "Android.Content.Context, Mono.Android", this, new Object[]{context});
        }
    }
    ...
    public ListViewRenderer_SwipeRefreshLayoutWithFixedNestedScrolling(Context context, AttributeSet attributeSet) {
        ...
        if (getClass() == ListViewRenderer_SwipeRefreshLayoutWithFixedNestedScrolling.class) {
            TypeManager.Activate("Microsoft.Maui.Controls.Handlers.Compatibility.ListViewRenderer+SwipeRefreshLayoutWithFixedNestedScrolling, Microsoft.Maui.Controls", "Android.Content.Context, Mono.Android:Android.Util.IAttributeSet, Mono.Android", this, new Object[]{context, attributeSet});
        }
    }
