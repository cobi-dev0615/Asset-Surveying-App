...
public class GradientStrokeDrawable extends PaintDrawable implements IGCUserPeer {
    ...
    static {
        Runtime.register("Microsoft.Maui.Controls.Platform.GradientStrokeDrawable, Microsoft.Maui.Controls", GradientStrokeDrawable.class, __md_methods);
    }

    public GradientStrokeDrawable() {
        if (getClass() == GradientStrokeDrawable.class) {
            TypeManager.Activate("Microsoft.Maui.Controls.Platform.GradientStrokeDrawable, Microsoft.Maui.Controls", "", this, new Object[0]);
        }
    }
