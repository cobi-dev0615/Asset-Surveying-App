...
public class DataChangeObserver extends RecyclerView.AdapterDataObserver implements IGCUserPeer {
    ...
    static {
        Runtime.register("Microsoft.Maui.Controls.Handlers.Items.DataChangeObserver, Microsoft.Maui.Controls", DataChangeObserver.class, __md_methods);
    }

    public DataChangeObserver() {
        if (getClass() == DataChangeObserver.class) {
            TypeManager.Activate("Microsoft.Maui.Controls.Handlers.Items.DataChangeObserver, Microsoft.Maui.Controls", "", this, new Object[0]);
        }
    }
