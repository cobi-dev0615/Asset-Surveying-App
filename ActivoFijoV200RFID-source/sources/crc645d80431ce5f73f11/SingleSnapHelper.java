...
public class SingleSnapHelper extends PagerSnapHelper implements IGCUserPeer {
    ...
    static {
        Runtime.register("Microsoft.Maui.Controls.Handlers.Items.SingleSnapHelper, Microsoft.Maui.Controls", SingleSnapHelper.class, __md_methods);
    }

    public SingleSnapHelper() {
        if (getClass() == SingleSnapHelper.class) {
            TypeManager.Activate("Microsoft.Maui.Controls.Handlers.Items.SingleSnapHelper, Microsoft.Maui.Controls", "", this, new Object[0]);
        }
    }
