...
public class RecyclerViewScrollListener_2 extends RecyclerView.OnScrollListener implements IGCUserPeer {
    ...
    static {
        Runtime.register("Microsoft.Maui.Controls.Handlers.Items.RecyclerViewScrollListener`2, Microsoft.Maui.Controls", RecyclerViewScrollListener_2.class, "n_onScrolled:(Landroidx/recyclerview/widget/RecyclerView;II)V:GetOnScrolled_Landroidx_recyclerview_widget_RecyclerView_IIHandler\n");
    }

    public RecyclerViewScrollListener_2() {
        if (getClass() == RecyclerViewScrollListener_2.class) {
            TypeManager.Activate("Microsoft.Maui.Controls.Handlers.Items.RecyclerViewScrollListener`2, Microsoft.Maui.Controls", "", this, new Object[0]);
        }
    }
