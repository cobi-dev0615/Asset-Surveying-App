...
public class ItemsViewAdapter_2 extends RecyclerView.Adapter implements IGCUserPeer {
    ...
    static {
        Runtime.register("Microsoft.Maui.Controls.Handlers.Items.ItemsViewAdapter`2, Microsoft.Maui.Controls", ItemsViewAdapter_2.class, __md_methods);
    }

    public ItemsViewAdapter_2() {
        if (getClass() == ItemsViewAdapter_2.class) {
            TypeManager.Activate("Microsoft.Maui.Controls.Handlers.Items.ItemsViewAdapter`2, Microsoft.Maui.Controls", "", this, new Object[0]);
        }
    }
