...
public class PositionalSmoothScroller extends LinearSmoothScroller implements IGCUserPeer {
    ...
    static {
        Runtime.register("Microsoft.Maui.Controls.Handlers.Items.PositionalSmoothScroller, Microsoft.Maui.Controls", PositionalSmoothScroller.class, __md_methods);
    }

    public PositionalSmoothScroller(Context context) {
        super(context);
        if (getClass() == PositionalSmoothScroller.class) {
            TypeManager.Activate("Microsoft.Maui.Controls.Handlers.Items.PositionalSmoothScroller, Microsoft.Maui.Controls", "Android.Content.Context, Mono.Android", this, new Object[]{context});
        }
    }
