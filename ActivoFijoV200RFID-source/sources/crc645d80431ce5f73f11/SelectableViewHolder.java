...
public abstract class SelectableViewHolder extends RecyclerView.ViewHolder implements IGCUserPeer, View.OnClickListener {
    ...
    static {
        Runtime.register("Microsoft.Maui.Controls.Handlers.Items.SelectableViewHolder, Microsoft.Maui.Controls", SelectableViewHolder.class, "n_onClick:(Landroid/view/View;)V:GetOnClick_Landroid_view_View_Handler:Android.Views.View/IOnClickListenerInvoker, Mono.Android, Version=0.0.0.0, Culture=neutral, PublicKeyToken=null\n");
    }

    public SelectableViewHolder(View view) {
        super(view);
        if (getClass() == SelectableViewHolder.class) {
            TypeManager.Activate("Microsoft.Maui.Controls.Handlers.Items.SelectableViewHolder, Microsoft.Maui.Controls", "Android.Views.View, Mono.Android", this, new Object[]{view});
        }
    }
