...
final class DateEditPicker$decadeViewsManager$1$viewsUpdater$2 extends Lambda implements Function3<View, Integer, Function1<? super Integer, ? extends Integer>, Unit> {
    final /* synthetic */ DateEditPicker this$0;
    final /* synthetic */ DateEditPicker$decadeViewsManager$1 this$1;

    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    DateEditPicker$decadeViewsManager$1$viewsUpdater$2(DateEditPicker dateEditPicker, DateEditPicker$decadeViewsManager$1 dateEditPicker$decadeViewsManager$1) {
        super(3);
        this.this$0 = dateEditPicker;
        this.this$1 = dateEditPicker$decadeViewsManager$1;
    }
    ...
    public static final void invoke$lambda$0(DateEditPicker this$0, Function1 c, int i, View view) {
        ...
        this$0.onYearClick(((Number) c.invoke(Integer.valueOf(i))).intValue());
    }
    ...
    public final void invoke(View v, final int i, final Function1<? super Integer, Integer> c) {
        ...
        v.setOnClickListener(new View.OnClickListener() { // from class: com.devexpress.editors.pickers.DateEditPicker$decadeViewsManager$1$viewsUpdater$2$$ExternalSyntheticLambda0
            @Override // android.view.View.OnClickListener
            public final void onClick(View view) {
                DateEditPicker$decadeViewsManager$1$viewsUpdater$2.invoke$lambda$0(DateEditPicker.this, c, i, view);
            }
        });
    }
}
