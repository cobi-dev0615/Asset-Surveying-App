...
final class XYQualitativeSeriesDataAdapter extends XYSeriesDataAdapterBase {
    ...
    XYQualitativeSeriesDataAdapter(QualitativeSeriesData qualitativeSeriesData) {
        super(qualitativeSeriesData);
    }
