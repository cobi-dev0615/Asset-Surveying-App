...
/* compiled from: MovingAverangeDataAdapter.java */
/* loaded from: classes.dex */
class MovingAverageDataAdapter extends ValueLevelDataAdapter {
    int _pointsCount;
    ...
    public static MovingAverageDataAdapter create(CalculatedSeriesDataWrapper calculatedSeriesDataWrapper, long j, ValueLevel valueLevel, Object obj, int i) {
        MovingAverageDataAdapter movingAverageDataAdapter = new MovingAverageDataAdapter(calculatedSeriesDataWrapper, valueLevel, i);
        movingAverageDataAdapter.initialize(j);
        movingAverageDataAdapter.setSyncObject(obj);
        return movingAverageDataAdapter;
    }

    MovingAverageDataAdapter(CalculatedSeriesDataWrapper calculatedSeriesDataWrapper, ValueLevel valueLevel, int i) {
