...
class TriangularMovingAverageDataAdapter extends ValueLevelDataAdapter {
    int _pointsCount;
    ...
    public static TriangularMovingAverageDataAdapter create(CalculatedSeriesDataWrapper calculatedSeriesDataWrapper, long j, ValueLevel valueLevel, Object obj, int i) {
        TriangularMovingAverageDataAdapter triangularMovingAverageDataAdapter = new TriangularMovingAverageDataAdapter(calculatedSeriesDataWrapper, valueLevel, i);
        triangularMovingAverageDataAdapter.initialize(j);
        triangularMovingAverageDataAdapter.setSyncObject(obj);
        return triangularMovingAverageDataAdapter;
    }

    TriangularMovingAverageDataAdapter(CalculatedSeriesDataWrapper calculatedSeriesDataWrapper, ValueLevel valueLevel, int i) {
