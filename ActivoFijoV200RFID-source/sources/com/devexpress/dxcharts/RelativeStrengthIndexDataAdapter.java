...
class RelativeStrengthIndexDataAdapter extends ValueLevelDataAdapter {
    int _pointsCount;
    ...
    public static RelativeStrengthIndexDataAdapter create(CalculatedSeriesDataWrapper calculatedSeriesDataWrapper, long j, ValueLevel valueLevel, Object obj, int i) {
        RelativeStrengthIndexDataAdapter relativeStrengthIndexDataAdapter = new RelativeStrengthIndexDataAdapter(calculatedSeriesDataWrapper, valueLevel, i);
        relativeStrengthIndexDataAdapter.initialize(j);
        relativeStrengthIndexDataAdapter.setSyncObject(obj);
        return relativeStrengthIndexDataAdapter;
    }

    RelativeStrengthIndexDataAdapter(CalculatedSeriesDataWrapper calculatedSeriesDataWrapper, ValueLevel valueLevel, int i) {
