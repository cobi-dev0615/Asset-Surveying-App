...
class RegressionLineDataAdapter extends ValueLevelDataAdapter {
    ...
    public static RegressionLineDataAdapter create(CalculatedSeriesDataWrapper calculatedSeriesDataWrapper, long j, ValueLevel valueLevel, Object obj) {
        RegressionLineDataAdapter regressionLineDataAdapter = new RegressionLineDataAdapter(calculatedSeriesDataWrapper, valueLevel);
        regressionLineDataAdapter.initialize(j);
        regressionLineDataAdapter.setSyncObject(obj);
        return regressionLineDataAdapter;
    }

    RegressionLineDataAdapter(CalculatedSeriesDataWrapper calculatedSeriesDataWrapper, ValueLevel valueLevel) {
    ...
    long createNativeAdapter(long j) {
        return nativeSetData(getData(), j, getValueLevel().ordinal());
    }
