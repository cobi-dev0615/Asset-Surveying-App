...
class GLTextureView extends TextureView implements TextureView.SurfaceTextureListener, ChartViewHolder {
    ...
    public interface Renderer extends GLSurfaceView.Renderer {
        Bitmap drawFrameToBitmap(ChartViewHolder chartViewHolder);
    ...
    public Bitmap getDrawingCache(boolean z) {
        return this.mRenderer.drawFrameToBitmap(this);
    }
    ...
    public void setRenderer(GLRenderer gLRenderer) {
        ...
        setRendererInternal(gLRenderer);
        setRenderMode(0);
    }

    private void setRendererInternal(Renderer renderer) {
    ...
    private class DefaultContextFactory implements EGLContextFactory {
        ...
        @Override // com.devexpress.dxcharts.GLTextureView.EGLContextFactory
    ...
    private static class DefaultWindowSurfaceFactory implements EGLWindowSurfaceFactory {
        ...
        @Override // com.devexpress.dxcharts.GLTextureView.EGLWindowSurfaceFactory
    ...
    private class ComponentSizeChooser extends BaseConfigChooser {
        ...
        @Override // com.devexpress.dxcharts.GLTextureView.BaseConfigChooser
    ...
    static class GLThread extends Thread {
        ...
        /* JADX WARN: Removed duplicated region for block: B:177:0x0225 A[EXC_TOP_SPLITTER, SYNTHETIC] */
        /*
        ...
        */
        private void guardedRun() throws java.lang.InterruptedException {
            ...
            */
            throw new UnsupportedOperationException("Method not decompiled: com.devexpress.dxcharts.GLTextureView.GLThread.guardedRun():void");
        }
