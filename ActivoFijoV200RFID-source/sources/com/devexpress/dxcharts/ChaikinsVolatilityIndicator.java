...
public class ChaikinsVolatilityIndicator extends CalculatedSeries {
    int _pointsCount = 14;
    ...
    SeriesDataAdapterBase createDataAdapter(XYSeriesData xYSeriesData) {
        if (xYSeriesData instanceof CalculatedSeriesData) {
            return ChaikinsVolatilityDataAdapter.create(new CalculatedSeriesDataWrapper((CalculatedSeriesData) xYSeriesData), getNativeSeries(), getSyncObject(), this._pointsCount);
        }
        return null;
    }
