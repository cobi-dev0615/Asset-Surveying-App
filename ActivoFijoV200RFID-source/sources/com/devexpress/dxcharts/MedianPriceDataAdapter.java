...
class MedianPriceDataAdapter extends XYSeriesDataAdapterBase {
    ...
    public static MedianPriceDataAdapter create(CalculatedSeriesDataWrapper calculatedSeriesDataWrapper, long j, Object obj) {
        MedianPriceDataAdapter medianPriceDataAdapter = new MedianPriceDataAdapter(calculatedSeriesDataWrapper);
        medianPriceDataAdapter.initialize(j);
        medianPriceDataAdapter.setSyncObject(obj);
        return medianPriceDataAdapter;
    }

    MedianPriceDataAdapter(CalculatedSeriesDataWrapper calculatedSeriesDataWrapper) {
