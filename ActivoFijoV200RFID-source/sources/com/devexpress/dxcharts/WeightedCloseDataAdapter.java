...
class WeightedCloseDataAdapter extends XYSeriesDataAdapterBase {
    ...
    public static WeightedCloseDataAdapter create(CalculatedSeriesDataWrapper calculatedSeriesDataWrapper, long j, Object obj) {
        WeightedCloseDataAdapter weightedCloseDataAdapter = new WeightedCloseDataAdapter(calculatedSeriesDataWrapper);
        weightedCloseDataAdapter.initialize(j);
        weightedCloseDataAdapter.setSyncObject(obj);
        return weightedCloseDataAdapter;
    }

    WeightedCloseDataAdapter(CalculatedSeriesDataWrapper calculatedSeriesDataWrapper) {
