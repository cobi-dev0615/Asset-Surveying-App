...
public class StandardDeviationIndicator extends CalculatedSeries {
    ...
    SeriesDataAdapterBase createDataAdapter(XYSeriesData xYSeriesData) {
        ...
        return StandardDeviationDataAdapter.create(new CalculatedSeriesDataWrapper(calculatedSeriesData), getNativeSeries(), getActualValueLevel(this._valueLevel, calculatedSeriesData), getSyncObject(), this._pointsCount);
    }
