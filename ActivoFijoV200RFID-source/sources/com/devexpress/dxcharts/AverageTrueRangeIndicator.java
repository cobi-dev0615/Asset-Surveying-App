...
public class AverageTrueRangeIndicator extends CalculatedSeries {
    int _pointsCount = 14;
    ...
    SeriesDataAdapterBase createDataAdapter(XYSeriesData xYSeriesData) {
        if (xYSeriesData instanceof CalculatedSeriesData) {
            return AverageTrueRangeDataAdapter.create(new CalculatedSeriesDataWrapper((CalculatedSeriesData) xYSeriesData), getNativeSeries(), getSyncObject(), this._pointsCount);
        }
        return null;
    }
