...
class CommodityChannelIndexDataAdapter extends XYSeriesDataAdapterBase {
    int _pointsCount;
    ...
    public static CommodityChannelIndexDataAdapter create(CalculatedSeriesDataWrapper calculatedSeriesDataWrapper, long j, Object obj, int i) {
        CommodityChannelIndexDataAdapter commodityChannelIndexDataAdapter = new CommodityChannelIndexDataAdapter(calculatedSeriesDataWrapper, i);
        commodityChannelIndexDataAdapter.initialize(j);
        commodityChannelIndexDataAdapter.setSyncObject(obj);
        return commodityChannelIndexDataAdapter;
    }

    CommodityChannelIndexDataAdapter(CalculatedSeriesDataWrapper calculatedSeriesDataWrapper, int i) {
