...
/* compiled from: TypicalPticeDataAdapter.java */
/* loaded from: classes.dex */
class TypicalPriceDataAdapter extends XYSeriesDataAdapterBase {
    ...
    public static TypicalPriceDataAdapter create(CalculatedSeriesDataWrapper calculatedSeriesDataWrapper, long j, Object obj) {
        TypicalPriceDataAdapter typicalPriceDataAdapter = new TypicalPriceDataAdapter(calculatedSeriesDataWrapper);
        typicalPriceDataAdapter.initialize(j);
        typicalPriceDataAdapter.setSyncObject(obj);
        return typicalPriceDataAdapter;
    }

    TypicalPriceDataAdapter(CalculatedSeriesDataWrapper calculatedSeriesDataWrapper) {
        super(calculatedSeriesDataWrapper);
    }

    @Override // com.devexpress.dxcharts.SeriesDataAdapterBase
    long createNativeAdapter(long j) {
        return nativeSetData(getData(), j);
    }
