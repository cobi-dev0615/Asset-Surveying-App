...
public final class XAesGcmParams extends GeneratedMessageLite<XAesGcmParams, Builder> implements XAesGcmParamsOrBuilder {
    private static final XAesGcmParams DEFAULT_INSTANCE;
    private static volatile Parser<XAesGcmParams> PARSER = null;
    ...
    @Override // com.google.crypto.tink.proto.XAesGcmParamsOrBuilder
    ...
    /* JADX INFO: Access modifiers changed from: private */
    public void clearSaltSize() {
        this.saltSize_ = 0;
    }

    public static XAesGcmParams parseFrom(ByteBuffer data) throws InvalidProtocolBufferException {
        return (XAesGcmParams) GeneratedMessageLite.parseFrom(DEFAULT_INSTANCE, data);
    }
    ...
    public static XAesGcmParams parseFrom(ByteBuffer data, ExtensionRegistryLite extensionRegistry) throws InvalidProtocolBufferException {
        return (XAesGcmParams) GeneratedMessageLite.parseFrom(DEFAULT_INSTANCE, data, extensionRegistry);
    }
    ...
    public static XAesGcmParams parseFrom(InputStream input) throws IOException {
        return (XAesGcmParams) GeneratedMessageLite.parseFrom(DEFAULT_INSTANCE, input);
    }

    public static XAesGcmParams parseFrom(InputStream input, ExtensionRegistryLite extensionRegistry) throws IOException {
        return (XAesGcmParams) GeneratedMessageLite.parseFrom(DEFAULT_INSTANCE, input, extensionRegistry);
    }

    public static XAesGcmParams parseDelimitedFrom(InputStream input) throws IOException {
        return (XAesGcmParams) parseDelimitedFrom(DEFAULT_INSTANCE, input);
    }
    ...
    public static XAesGcmParams parseDelimitedFrom(InputStream input, ExtensionRegistryLite extensionRegistry) throws IOException {
        return (XAesGcmParams) parseDelimitedFrom(DEFAULT_INSTANCE, input, extensionRegistry);
    }
    ...
    public static final class Builder extends GeneratedMessageLite.Builder<XAesGcmParams, Builder> implements XAesGcmParamsOrBuilder {
        ...
        private Builder() {
            super(XAesGcmParams.DEFAULT_INSTANCE);
        }

        @Override // com.google.crypto.tink.proto.XAesGcmParamsOrBuilder
        public int getSaltSize() {
            return ((XAesGcmParams) this.instance).getSaltSize();
        }

        public Builder setSaltSize(int value) {
            copyOnWrite();
            ((XAesGcmParams) this.instance).setSaltSize(value);
            return this;
        }

        public Builder clearSaltSize() {
            copyOnWrite();
            ((XAesGcmParams) this.instance).clearSaltSize();
            return this;
        }
    }

    /* renamed from: com.google.crypto.tink.proto.XAesGcmParams$1, reason: invalid class name */
    ...
    protected final Object dynamicMethod(GeneratedMessageLite.MethodToInvoke method, Object arg0, Object arg1) {
        ...
        switch (AnonymousClass1.$SwitchMap$com$google$protobuf$GeneratedMessageLite$MethodToInvoke[method.ordinal()]) {
            ...
            case 3:
                return newMessageInfo(DEFAULT_INSTANCE, "\u0000\u0001\u0000\u0000\u0001\u0001\u0001\u0000\u0000\u0000\u0001\u000b", new Object[]{"saltSize_"});
            case 4:
                return DEFAULT_INSTANCE;
            case 5:
                Parser<XAesGcmParams> parser = PARSER;
                if (parser == null) {
