...
public abstract class GoogleApi<O extends Api.ApiOptions> implements HasApiKey<O> {
    ...
    protected ClientSettings.Builder createClientSettingsBuilder() {
        ...
        builder.zaa((!z || (googleSignInAccount = ((Api.ApiOptions.HasGoogleSignInAccountOptions) apiOptions).getGoogleSignInAccount()) == null) ? apiOptions instanceof Api.ApiOptions.HasAccountOptions ? ((Api.ApiOptions.HasAccountOptions) apiOptions).getAccount() : null : googleSignInAccount.getAccount());
        if (z) {
