...
public class GoogleApiAvailability extends GoogleApiAvailabilityLight {
    ...
    public Task<Void> checkApiAvailability(GoogleApi<?> googleApi, GoogleApi<?>... googleApiArr) {
        return zai(googleApi, googleApiArr).onSuccessTask(zac.zaa);
    }
    ...
    final void zag(Activity activity, Dialog dialog, String str, DialogInterface.OnCancelListener onCancelListener) {
        try {
    ...
    final void zah(Context context) {
        new zab(this, context).sendEmptyMessageDelayed(1, 120000L);
    }
    ...
    public Task<Void> checkApiAvailability(HasApiKey<?> hasApiKey, HasApiKey<?>... hasApiKeyArr) {
        return zai(hasApiKey, hasApiKeyArr).onSuccessTask(zad.zaa);
    }
