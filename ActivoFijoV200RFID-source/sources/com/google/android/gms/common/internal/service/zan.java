...
public final class zan extends GoogleApi implements TelemetryLoggingClient {
    ...
    public zan(Context context, TelemetryLoggingOptions telemetryLoggingOptions) {
    ...
    public final Task<Void> log(final TelemetryData telemetryData) {
        ...
        builder.run(new RemoteCall() { // from class: com.google.android.gms.common.internal.service.zao
