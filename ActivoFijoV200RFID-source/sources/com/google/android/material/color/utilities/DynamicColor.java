    ...
    public double getTone(DynamicScheme dynamicScheme) {
        ...
        if (function != null) {
            ...
            if ((doubleValue2 - d3) * d2 < delta) {
                double d4 = delta * d2;
                doubleValue2 = MathUtils.clampDouble(AudioStats.AUDIO_AMPLITUDE_NONE, 100.0d, d3 + d4);
                if ((doubleValue2 - d3) * d2 < delta) {
                    d3 = MathUtils.clampDouble(AudioStats.AUDIO_AMPLITUDE_NONE, 100.0d, doubleValue2 - d4);
                }
            }
            if (50.0d > d3 || d3 >= 60.0d) {
                if (50.0d > doubleValue2 || doubleValue2 >= 60.0d) {
                    ...
                    d = d2 > AudioStats.AUDIO_AMPLITUDE_NONE ? 60.0d : 49.0d;
