...
class KeylineStateList {
    ...
    private static List<KeylineState> getStateStepsStart(Carousel carousel, KeylineState keylineState, float f, float f2) {
        ...
        while (i2 < firstFocalKeylineIndex) {
            ...
            int i4 = i3 - i;
            int findFirstIndexAfterLastFocalKeylineWithMask = i4 >= 0 ? findFirstIndexAfterLastFocalKeylineWithMask(keylineState2, keylineState.getKeylines().get(i4).mask) - i : size;
            int i5 = i2;
