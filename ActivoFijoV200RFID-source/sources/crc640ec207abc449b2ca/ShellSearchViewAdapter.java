...
public class ShellSearchViewAdapter extends BaseAdapter implements IGCUserPeer, Filterable {
    ...
    static {
        Runtime.register("Microsoft.Maui.Controls.Platform.Compatibility.ShellSearchViewAdapter, Microsoft.Maui.Controls", ShellSearchViewAdapter.class, __md_methods);
    }

    public ShellSearchViewAdapter() {
        if (getClass() == ShellSearchViewAdapter.class) {
            TypeManager.Activate("Microsoft.Maui.Controls.Platform.Compatibility.ShellSearchViewAdapter, Microsoft.Maui.Controls", "", this, new Object[0]);
        }
    }
