...
public class ShellSearchView extends FrameLayout implements IGCUserPeer, TextView.OnEditorActionListener, TextWatcher, NoCopySpan {
    ...
    static {
        Runtime.register("Microsoft.Maui.Controls.Platform.Compatibility.ShellSearchView, Microsoft.Maui.Controls", ShellSearchView.class, __md_methods);
    }

    public ShellSearchView(Context context, AttributeSet attributeSet, int i, int i2) {
        super(context, attributeSet, i, i2);
        if (getClass() == ShellSearchView.class) {
            TypeManager.Activate("Microsoft.Maui.Controls.Platform.Compatibility.ShellSearchView, Microsoft.Maui.Controls", "Android.Content.Context, Mono.Android:Android.Util.IAttributeSet, Mono.Android:System.Int32, System.Private.CoreLib:System.Int32, System.Private.CoreLib", this, new Object[]{context, attributeSet, Integer.valueOf(i), Integer.valueOf(i2)});
        }
    }
    ...
    public ShellSearchView(Context context, AttributeSet attributeSet, int i) {
        ...
        if (getClass() == ShellSearchView.class) {
            TypeManager.Activate("Microsoft.Maui.Controls.Platform.Compatibility.ShellSearchView, Microsoft.Maui.Controls", "Android.Content.Context, Mono.Android:Android.Util.IAttributeSet, Mono.Android:System.Int32, System.Private.CoreLib", this, new Object[]{context, attributeSet, Integer.valueOf(i)});
        }
    }
    ...
    public ShellSearchView(Context context, AttributeSet attributeSet) {
        ...
        if (getClass() == ShellSearchView.class) {
            TypeManager.Activate("Microsoft.Maui.Controls.Platform.Compatibility.ShellSearchView, Microsoft.Maui.Controls", "Android.Content.Context, Mono.Android:Android.Util.IAttributeSet, Mono.Android", this, new Object[]{context, attributeSet});
        }
    }
    ...
    public ShellSearchView(Context context) {
        super(context);
        if (getClass() == ShellSearchView.class) {
            TypeManager.Activate("Microsoft.Maui.Controls.Platform.Compatibility.ShellSearchView, Microsoft.Maui.Controls", "Android.Content.Context, Mono.Android", this, new Object[]{context});
        }
    }
