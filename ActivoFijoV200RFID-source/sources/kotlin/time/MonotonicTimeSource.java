...
public final class MonotonicTimeSource implements TimeSource.WithComparableMarks {
    ...
    public /* bridge */ /* synthetic */ ComparableTimeMark markNow() {
        return TimeSource.Monotonic.ValueTimeMark.m2129boximpl(m2123markNowz9LOYto());
    }
    ...
    public long m2123markNowz9LOYto() {
        return TimeSource.Monotonic.ValueTimeMark.m2132constructorimpl(read());
    }

    /* renamed from: elapsedFrom-6eNON_k, reason: not valid java name */
    public final long m2122elapsedFrom6eNON_k(long timeMark) {
    ...
    public final long m2121differenceBetweenfRLX17w(long one, long another) {
        return LongSaturatedMathKt.saturatingOriginsDiff(one, another, DurationUnit.NANOSECONDS);
    }

    /* renamed from: adjustReading-6QKq23U, reason: not valid java name */
    public final long m2120adjustReading6QKq23U(long timeMark, long duration) {
        return TimeSource.Monotonic.ValueTimeMark.m2132constructorimpl(LongSaturatedMathKt.m2118saturatingAddNuflL3o(timeMark, DurationUnit.NANOSECONDS, duration));
    }
}
