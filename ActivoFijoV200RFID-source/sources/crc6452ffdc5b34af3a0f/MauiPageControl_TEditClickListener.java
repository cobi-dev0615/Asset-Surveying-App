...
public class MauiPageControl_TEditClickListener implements IGCUserPeer, View.OnClickListener {
    ...
    static {
        Runtime.register("Microsoft.Maui.Platform.MauiPageControl+TEditClickListener, Microsoft.Maui", MauiPageControl_TEditClickListener.class, "n_onClick:(Landroid/view/View;)V:GetOnClick_Landroid_view_View_Handler:Android.Views.View/IOnClickListenerInvoker, Mono.Android, Version=0.0.0.0, Culture=neutral, PublicKeyToken=null\n");
    }

    public MauiPageControl_TEditClickListener() {
        if (getClass() == MauiPageControl_TEditClickListener.class) {
            TypeManager.Activate("Microsoft.Maui.Platform.MauiPageControl+TEditClickListener, Microsoft.Maui", "", this, new Object[0]);
        }
    }
