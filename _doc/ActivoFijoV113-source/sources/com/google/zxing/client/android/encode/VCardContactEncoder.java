...
final class VCardContactEncoder extends ContactEncoder {
    ...
    public String[] encode(List<String> list, String str, List<String> list2, List<String> list3, List<String> list4, List<String> list5, List<String> list6, String str2) {
        ...
        appendUpToUnique(sb, sb2, "TEL", list3, ActivityChooserView.ActivityChooserViewAdapter.MAX_ACTIVITY_COUNT_UNLIMITED, new VCardTelDisplayFormatter(buildPhoneMetadata), new VCardFieldFormatter(buildPhoneMetadata), TERMINATOR);
        appendUpToUnique(sb, sb2, "EMAIL", list5, ActivityChooserView.ActivityChooserViewAdapter.MAX_ACTIVITY_COUNT_UNLIMITED, null, vCardFieldFormatter, TERMINATOR);
        appendUpToUnique(sb, sb2, "URL", list6, ActivityChooserView.ActivityChooserViewAdapter.MAX_ACTIVITY_COUNT_UNLIMITED, null, vCardFieldFormatter, TERMINATOR);
