...
final class MECARDContactEncoder extends ContactEncoder {
    ...
    public String[] encode(List<String> list, String str, List<String> list2, List<String> list3, List<String> list4, List<String> list5, List<String> list6, String str2) {
        ...
        appendUpToUnique(sb, sb2, "TEL", list3, ActivityChooserView.ActivityChooserViewAdapter.MAX_ACTIVITY_COUNT_UNLIMITED, new MECARDTelDisplayFormatter(), mECARDFieldFormatter, TERMINATOR);
        appendUpToUnique(sb, sb2, "EMAIL", list5, ActivityChooserView.ActivityChooserViewAdapter.MAX_ACTIVITY_COUNT_UNLIMITED, null, mECARDFieldFormatter, TERMINATOR);
        appendUpToUnique(sb, sb2, "URL", list6, ActivityChooserView.ActivityChooserViewAdapter.MAX_ACTIVITY_COUNT_UNLIMITED, null, mECARDFieldFormatter, TERMINATOR);
    ...
    private static class MECARDFieldFormatter implements Formatter {
        ...
        public CharSequence format(CharSequence charSequence, int i) {
            return ':' + NEWLINE.matcher(RESERVED_MECARD_CHARS.matcher(charSequence).replaceAll("\\\\$1")).replaceAll(BuildConfig.FLAVOR);
        }
    }
    ...
    private static class MECARDTelDisplayFormatter implements Formatter {
        ...
        @Override // com.google.zxing.client.android.encode.Formatter
        public CharSequence format(CharSequence charSequence, int i) {
            return NOT_DIGITS.matcher(PhoneNumberUtils.formatNumber(charSequence.toString())).replaceAll(BuildConfig.FLAVOR);
        }
    }
    ...
    private static class MECARDNameDisplayFormatter implements Formatter {
        ...
        @Override // com.google.zxing.client.android.encode.Formatter
        public CharSequence format(CharSequence charSequence, int i) {
            return COMMA.matcher(charSequence).replaceAll(BuildConfig.FLAVOR);
        }
    }
}
