    ...
    public static AztecCode encode(byte[] bArr, int i, int i2) {
        ...
        if (z) {
            ...
            for (int i20 = 0; i20 < i18; i20++) {
                iArr2[(i18 - i20) - 1] = (i19 - r15) - 1;
                iArr2[i18 + i20] = (i20 / 15) + i20 + i19 + 1;
            }
        }
        ...
        int i22 = 0;
        while (i21 < i4) {
            int i23 = ((i4 - i21) * 4) + (z ? 9 : 12);
            int i24 = 0;
            while (i24 < i23) {
                int i25 = i24 * 2;
                while (i7 < i16) {
                    if (generateCheckWords.get(i22 + i25 + i7)) {
                        int i26 = i21 * 2;
                        bitMatrix.set(iArr2[i26 + i7], iArr2[i26 + i24]);
                    }
                    if (generateCheckWords.get((i23 * 2) + i22 + i25 + i7)) {
                        int i27 = i21 * 2;
                        bitMatrix.set(iArr2[i27 + i24], iArr2[((i15 - 1) - i27) - i7]);
                    }
                    if (generateCheckWords.get((i23 * 4) + i22 + i25 + i7)) {
                        int i28 = (i15 - 1) - (i21 * 2);
                        bitMatrix.set(iArr2[i28 - i7], iArr2[i28 - i24]);
                    }
                    if (generateCheckWords.get((i23 * 6) + i22 + i25 + i7)) {
                        int i29 = i21 * 2;
                        bitMatrix.set(iArr2[((i15 - 1) - i29) - i24], iArr2[i29 + i7]);
                    }
                    i7++;
                    i16 = 2;
                }
