...
public class NotificationCompat {
    ...
    public static class MessagingStyle extends Style {
        ...
        private CharSequence makeMessageLine(Message message) {
            ...
            CharSequence name = person == null ? BuildConfig.FLAVOR : message.getPerson().getName();
    ...
    public static class Action {
        ...
        public Action(int icon, CharSequence title, PendingIntent intent) {
            this(icon != 0 ? IconCompat.createWithResource(null, BuildConfig.FLAVOR, icon) : null, title, intent);
        }
        ...
        Action(int icon, CharSequence title, PendingIntent intent, Bundle extras, RemoteInput[] remoteInputs, RemoteInput[] dataOnlyRemoteInputs, boolean allowGeneratedReplies, int semanticAction, boolean showsUserInterface, boolean isContextual) {
            this(icon != 0 ? IconCompat.createWithResource(null, BuildConfig.FLAVOR, icon) : null, title, intent, extras, remoteInputs, dataOnlyRemoteInputs, allowGeneratedReplies, semanticAction, showsUserInterface, isContextual);
        }
        ...
        public IconCompat getIconCompat() {
            ...
            if (this.mIcon == null && (i = this.icon) != 0) {
                this.mIcon = IconCompat.createWithResource(null, BuildConfig.FLAVOR, i);
            }
            return this.mIcon;
        }
        ...
        public static final class Builder {
            ...
            public Builder(int icon, CharSequence title, PendingIntent intent) {
                this(icon != 0 ? IconCompat.createWithResource(null, BuildConfig.FLAVOR, icon) : null, title, intent, new Bundle(), null, true, 0, true, false);
            }
