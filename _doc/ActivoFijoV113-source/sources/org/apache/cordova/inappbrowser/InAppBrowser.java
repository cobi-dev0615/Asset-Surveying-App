...
public class InAppBrowser extends CordovaPlugin {
    ...
    private String closeButtonCaption = BuildConfig.FLAVOR;
    private String closeButtonColor = BuildConfig.FLAVOR;
    private boolean leftToRight = false;
    private int toolbarColor = -3355444;
    private boolean hideNavigationButtons = false;
    private String navigationButtonColor = BuildConfig.FLAVOR;
    private boolean hideUrlBar = false;
    private boolean showFooter = false;
    private String footerColor = BuildConfig.FLAVOR;
    private String beforeload = BuildConfig.FLAVOR;
    ...
    public void navigate(String url) {
        ...
        if (!url.startsWith(ProxyConfig.MATCH_HTTP) && !url.startsWith("file:")) {
    ...
    public String showWebPage(final String url, HashMap<String, String> features) {
        ...
        if (features != null) {
            ...
            this.leftToRight = str14 != null && str14.equals("yes");
        ...
        this.cordova.getActivity().runOnUiThread(new Runnable() { // from class: org.apache.cordova.inappbrowser.InAppBrowser.7
            ...
            private View createCloseButton(int i) {
                ...
                if (InAppBrowser.this.closeButtonCaption != BuildConfig.FLAVOR) {
                    ...
                    if (InAppBrowser.this.closeButtonColor != BuildConfig.FLAVOR) {
            ...
            public void run() {
                ...
                if (InAppBrowser.this.navigationButtonColor != BuildConfig.FLAVOR) {
                ...
                relativeLayout3.setBackgroundColor(InAppBrowser.this.footerColor != BuildConfig.FLAVOR ? Color.parseColor(InAppBrowser.this.footerColor) : -3355444);
