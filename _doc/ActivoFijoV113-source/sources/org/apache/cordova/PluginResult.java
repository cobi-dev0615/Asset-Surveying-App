...
public class PluginResult {
    ...
    public PluginResult(Status status, int i) {
        ...
        this.status = status.ordinal();
        this.messageType = 3;
        this.encodedMessage = barcodescanner.xservices.nl.barcodescanner.BuildConfig.FLAVOR + i;
    }
    ...
    public PluginResult(Status status, float f) {
        ...
        this.status = status.ordinal();
        this.messageType = 3;
        this.encodedMessage = barcodescanner.xservices.nl.barcodescanner.BuildConfig.FLAVOR + f;
    }
