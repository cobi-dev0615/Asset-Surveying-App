...
public class ExifInterface {
    ...
    private static class ExifAttribute {
        ...
        public static ExifAttribute createByte(String str) {
            ...
            return new ExifAttribute(1, 1, new byte[]{(byte) (str.charAt(0) - Mask.DIGIT_SYMBOL)});
        }
        ...
        /* JADX WARN: Not initialized variable reg: 3, insn: 0x01a6: MOVE (r2 I:??[OBJECT, ARRAY]) = (r3 I:??[OBJECT, ARRAY]), block:B:167:0x01a6 */
    ...
    public void setAttribute(String str, String str2) {
        ...
        if (str4 != null) {
            if (RATIONAL_TAGS_HANDLED_AS_DECIMALS_FOR_COMPATIBILITY.contains(str3) && !str4.contains("/")) {
                try {
                    str4 = Rational.createFromDouble(Double.parseDouble(str2)).toString();
                } catch (NumberFormatException unused) {
        ...
        if (TAG_XMP.equals(str3)) {
            ...
            if ((xmpHandlingForImageType == 2 && (this.mXmpFromSeparateMarker != null || !z)) || (xmpHandlingForImageType == 3 && !z)) {
                this.mXmpFromSeparateMarker = ExifAttribute.createByte(str4);
                return;
            }
        }
        int i4 = 0;
        while (i4 < EXIF_TAGS.length) {
            if ((i4 != 4 || this.mHasThumbnail) && (exifTag = sExifTagMapsForWriting[i4].get(str3)) != null) {
                if (str4 == null) {
                    ...
                    } else if (exifTag.primaryFormat == 1 || exifTag.primaryFormat == 7 || exifTag.primaryFormat == i2) {
                        i = exifTag.primaryFormat;
                    } else if (DEBUG) {
                    ...
                    switch (i) {
                        ...
                        case 10:
                            ...
                            while (i10 < split6.length) {
                                ...
                                rationalArr2[i10] = new Rational((long) Double.parseDouble(split7[i3]), (long) Double.parseDouble(split7[1]));
                                i10++;
                                i3 = 0;
                            }
                        ...
                        case 12:
                            ...
                            for (int i11 = i3; i11 < split8.length; i11++) {
    ...
    */
            ...
            try {
                ...
                if (str3 != null) {
                    ...
                    if (("+".equals(substring) || "-".equals(substring)) && ":".equals(str3.substring(3, 4)) && parseInt <= 14) {
                        int i2 = ((parseInt * 60) + parseInt2) * UsbId.SILABS_CP2102;
                        if (!"-".equals(substring)) {
                            i = -1;
                        }
                        time += i2 * i;
    ...
    /* JADX WARN: Removed duplicated region for block: B:32:0x0153 A[LOOP:0: B:9:0x0034->B:32:0x0153, LOOP_END] */
    ...
    */
    ...
    /* JADX WARN: Unsupported multi-entry loop pattern (BACK_EDGE: B:31:0x0092 -> B:7:0x003d). Please report as a decompilation issue!!! */
    /*
        Code decompiled incorrectly, please refer to instructions dump.
        To view partially-correct add '--show-bad-code' argument
    */
    ...
    /* JADX WARN: Removed duplicated region for block: B:18:0x0204 A[Catch: all -> 0x0217, Exception -> 0x021a, TryCatch #5 {Exception -> 0x021a, all -> 0x0217, blocks: (B:9:0x004e, B:11:0x005c, B:13:0x0070, B:14:0x0072, B:16:0x01e8, B:18:0x0204, B:19:0x020d, B:23:0x007e, B:25:0x008d, B:27:0x0095, B:28:0x0099, B:31:0x00a9, B:33:0x00b4, B:34:0x00b9, B:36:0x00bb, B:41:0x00c9, B:39:0x00ce, B:44:0x00d2, B:46:0x00de, B:48:0x00e6, B:52:0x00f5, B:54:0x00fd, B:55:0x0101, B:57:0x010c, B:59:0x011c, B:61:0x016e, B:63:0x017a, B:64:0x0183, B:66:0x01c3, B:67:0x01df, B:68:0x01cf, B:70:0x01d7, B:71:0x0129, B:72:0x0130, B:73:0x0131, B:75:0x0139, B:77:0x013f, B:80:0x0157, B:82:0x0161, B:83:0x0168), top: B:8:0x004e }] */
    /* JADX WARN: Removed duplicated region for block: B:63:0