...
public class CLContainer extends CLElement {
    ...
    public CLContainer mo338clone() {
        CLContainer cLContainer = (CLContainer) super.mo338clone();
        ArrayList<CLElement> arrayList = new ArrayList<>(this.mElements.size());
        Iterator<CLElement> it = this.mElements.iterator();
        while (it.hasNext()) {
            CLElement mo338clone = it.next().mo338clone();
            mo338clone.setContainer(cLContainer);
