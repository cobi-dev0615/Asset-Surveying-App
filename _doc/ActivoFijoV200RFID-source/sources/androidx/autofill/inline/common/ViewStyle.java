...
public class ViewStyle extends BundledStyle {
    ...
    public void applyStyleOnViewIfValid(View view) {
        ...
        if (isValid()) {
            if (this.mBundle.containsKey(KEY_BACKGROUND) && (icon = (Icon) this.mBundle.getParcelable(KEY_BACKGROUND)) != null && (loadDrawable = icon.loadDrawable(view.getContext())) != null) {
