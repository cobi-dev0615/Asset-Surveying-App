...
public class StreamSharing extends UseCase {
    ...
    /* synthetic */ ListenableFuture m222lambda$new$0$androidxcameracorestreamsharingStreamSharing(int i, int i2) {
    ...
    private List<SessionConfig> createPipelineAndUpdateChildrenSpecs(String str, String str2, UseCaseConfig<?> useCaseConfig, StreamSpec streamSpec, StreamSpec streamSpec2) {
        ...
        if (streamSpec2 == null) {
            ...
            m2 = UByte$$ExternalSyntheticBackport0.m(new Object[]{this.mSessionConfigBuilder.build()});
            return m2;
        }
        ...
        m = UByte$$ExternalSyntheticBackport0.m(new Object[]{this.mSessionConfigBuilder.build(), this.mSecondarySessionConfigBuilder.build()});
        return m;
    }
    ...
    private void addCameraErrorListener(SessionConfig.Builder builder, final String str, final String str2, final UseCaseConfig<?> useCaseConfig, final StreamSpec streamSpec, final StreamSpec streamSpec2) {
        ...
        SessionConfig.CloseableErrorListener closeableErrorListener2 = new SessionConfig.CloseableErrorListener(new SessionConfig.ErrorListener() { // from class: androidx.camera.core.streamsharing.StreamSharing$$ExternalSyntheticLambda3
            ...
            public final void onError(SessionConfig sessionConfig, SessionConfig.SessionError sessionError) {
                StreamSharing.this.m221x83a3b685(str, str2, useCaseConfig, streamSpec, streamSpec2, sessionConfig, sessionError);
            }
        });
    ...
    /* synthetic */ void m221x83a3b685(String str, String str2, UseCaseConfig useCaseConfig, StreamSpec streamSpec, StreamSpec streamSpec2, SessionConfig sessionConfig, SessionConfig.SessionError sessionError) {
        if (getCamera() == null) {
            return;
        }
        clearPipeline();
