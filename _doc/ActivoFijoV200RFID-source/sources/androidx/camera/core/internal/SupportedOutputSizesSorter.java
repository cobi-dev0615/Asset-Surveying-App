...
public class SupportedOutputSizesSorter {
    ...
    private static List<Size> applyResolutionFilter(List<Size> list, ResolutionFilter resolutionFilter, int i, int i2, int i3) {
        ...
        List<Size> filter = resolutionFilter.filter(new ArrayList(list), CameraOrientationUtil.getRelativeImageRotation(CameraOrientationUtil.surfaceRotationToDegrees(i), i2, i3 == 1));
