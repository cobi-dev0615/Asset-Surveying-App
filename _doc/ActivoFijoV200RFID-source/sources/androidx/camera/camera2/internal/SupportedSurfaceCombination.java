...
final class SupportedSurfaceCombination {
    ...
    Pair<Map<UseCaseConfig<?>, StreamSpec>, Map<AttachedSurfaceInfo, StreamSpec>> getSuggestedStreamSpecifications(int i, List<AttachedSurfaceInfo> list, Map<UseCaseConfig<?>, List<Size>> map, boolean z, boolean z2) {
        ...
        while (true) {
            ...
            int i11 = i2;
            boolean z5 = range == null || i11 <= i8 || i8 >= range.getLower().intValue();
        ...
        if (list4 != null) {
            ...
            while (it4.hasNext()) {
                ...
                StreamSpec.Builder zslDisabled = StreamSpec.builder(list4.get(list11.indexOf(Integer.valueOf(arrayList.indexOf(next2))))).setDynamicRange((DynamicRange) Preconditions.checkNotNull(map3.get(next2))).setImplementationOptions(StreamUseCaseUtil.getStreamSpecImplementationOptions(next2)).setZslDisabled(z2);
                if (closestSupportedDeviceFrameRate != null) {
                    zslDisabled.setExpectedFrameRateRange(closestSupportedDeviceFrameRate);
                }
                hashMap2.put(next2, zslDisabled.build());
                it4 = it5;
                list2 = list11;
                map2 = map3;
