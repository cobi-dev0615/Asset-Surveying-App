...
public abstract class VersionedParcel {
    ...
    public Exception readException(Exception exc, int i) {
        ...
        return (readField(i) && (readExceptionCode = readExceptionCode()) != 0) ? createException(readExceptionCode, readString()) : exc;
    }
    ...
    public Size readSize(Size size, int i) {
        return !readField(i) ? size : Api21Impl.readSize(this);
    }

    public SizeF readSizeF(SizeF sizeF, int i) {
        return !readField(i) ? sizeF : Api21Impl.readSizeF(this);
    }
    ...
    private static final class Api21Impl {
        ...
        static void writeSize(VersionedParcel versionedParcel, Size size) {
        ...
        static void writeSizeF(VersionedParcel versionedParcel, SizeF sizeF) {
        ...
        static Size readSize(VersionedParcel versionedParcel) {
        ...
        static SizeF readSizeF(VersionedParcel versionedParcel) {
            if (versionedParcel.readBoolean()) {
