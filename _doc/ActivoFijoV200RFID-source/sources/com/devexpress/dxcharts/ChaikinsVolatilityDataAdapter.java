...
class ChaikinsVolatilityDataAdapter extends XYSeriesDataAdapterBase {
    int _pointsCount;
    ...
    public static ChaikinsVolatilityDataAdapter create(CalculatedSeriesDataWrapper calculatedSeriesDataWrapper, long j, Object obj, int i) {
        ChaikinsVolatilityDataAdapter chaikinsVolatilityDataAdapter = new ChaikinsVolatilityDataAdapter(calculatedSeriesDataWrapper, i);
        chaikinsVolatilityDataAdapter.initialize(j);
        chaikinsVolatilityDataAdapter.setSyncObject(obj);
        return chaikinsVolatilityDataAdapter;
    }

    ChaikinsVolatilityDataAdapter(CalculatedSeriesDataWrapper calculatedSeriesDataWrapper, int i) {
