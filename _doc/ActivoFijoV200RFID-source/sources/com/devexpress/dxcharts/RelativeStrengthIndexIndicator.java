...
public class RelativeStrengthIndexIndicator extends CalculatedSeries {
    ...
    SeriesDataAdapterBase createDataAdapter(XYSeriesData xYSeriesData) {
        ...
        return RelativeStrengthIndexDataAdapter.create(new CalculatedSeriesDataWrapper(calculatedSeriesData), getNativeSeries(), getActualValueLevel(this._valueLevel, calculatedSeriesData), getSyncObject(), this._pointsCount);
    }
