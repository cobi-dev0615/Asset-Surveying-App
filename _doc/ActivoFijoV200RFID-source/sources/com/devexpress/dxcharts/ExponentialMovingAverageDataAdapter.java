...
class ExponentialMovingAverageDataAdapter extends ValueLevelDataAdapter {
    int _pointsCount;
    ...
    public static ExponentialMovingAverageDataAdapter create(CalculatedSeriesDataWrapper calculatedSeriesDataWrapper, long j, ValueLevel valueLevel, Object obj, int i) {
        ExponentialMovingAverageDataAdapter exponentialMovingAverageDataAdapter = new ExponentialMovingAverageDataAdapter(calculatedSeriesDataWrapper, valueLevel, i);
        exponentialMovingAverageDataAdapter.initialize(j);
        exponentialMovingAverageDataAdapter.setSyncObject(obj);
        return exponentialMovingAverageDataAdapter;
    }

    ExponentialMovingAverageDataAdapter(CalculatedSeriesDataWrapper calculatedSeriesDataWrapper, ValueLevel valueLevel, int i) {
