...
class WeightedMovingAverageDataAdapter extends ValueLevelDataAdapter {
    int _pointsCount;
    ...
    public static WeightedMovingAverageDataAdapter create(CalculatedSeriesDataWrapper calculatedSeriesDataWrapper, long j, ValueLevel valueLevel, Object obj, int i) {
        WeightedMovingAverageDataAdapter weightedMovingAverageDataAdapter = new WeightedMovingAverageDataAdapter(calculatedSeriesDataWrapper, valueLevel, i);
        weightedMovingAverageDataAdapter.initialize(j);
        weightedMovingAverageDataAdapter.setSyncObject(obj);
        return weightedMovingAverageDataAdapter;
    }

    WeightedMovingAverageDataAdapter(CalculatedSeriesDataWrapper calculatedSeriesDataWrapper, ValueLevel valueLevel, int i) {
