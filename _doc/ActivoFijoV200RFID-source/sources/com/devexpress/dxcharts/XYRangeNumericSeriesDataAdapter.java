...
final class XYRangeNumericSeriesDataAdapter extends XYSeriesDataAdapterBase {
    ...
    XYRangeNumericSeriesDataAdapter(RangeNumericSeriesData rangeNumericSeriesData) {
        super(rangeNumericSeriesData);
    }
