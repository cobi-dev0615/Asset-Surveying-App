...
public class MovingAverageIndicator extends CalculatedSeries {
    static final int DefaultPointsCount = 20;
    ...
    SeriesDataAdapterBase createDataAdapter(XYSeriesData xYSeriesData) {
        ...
        return MovingAverageDataAdapter.create(new CalculatedSeriesDataWrapper(calculatedSeriesData), getNativeSeries(), getActualValueLevel(this._valueLevel, calculatedSeriesData), getSyncObject(), this._pointsCount);
    }
