...
class StandardDeviationDataAdapter extends ValueLevelDataAdapter {
    int _pointsCount;
    ...
    public static StandardDeviationDataAdapter create(CalculatedSeriesDataWrapper calculatedSeriesDataWrapper, long j, ValueLevel valueLevel, Object obj, int i) {
        StandardDeviationDataAdapter standardDeviationDataAdapter = new StandardDeviationDataAdapter(calculatedSeriesDataWrapper, valueLevel, i);
        standardDeviationDataAdapter.initialize(j);
        standardDeviationDataAdapter.setSyncObject(obj);
        return standardDeviationDataAdapter;
    }

    StandardDeviationDataAdapter(CalculatedSeriesDataWrapper calculatedSeriesDataWrapper, ValueLevel valueLevel, int i) {
