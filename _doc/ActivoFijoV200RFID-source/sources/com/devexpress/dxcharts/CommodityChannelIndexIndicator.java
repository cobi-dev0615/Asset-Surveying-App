...
public class CommodityChannelIndexIndicator extends CalculatedSeries {
    int _pointsCount = 14;
    ...
    SeriesDataAdapterBase createDataAdapter(XYSeriesData xYSeriesData) {
        if (xYSeriesData instanceof CalculatedSeriesData) {
            return CommodityChannelIndexDataAdapter.create(new CalculatedSeriesDataWrapper((CalculatedSeriesData) xYSeriesData), getNativeSeries(), getSyncObject(), this._pointsCount);
        }
        return null;
    }
