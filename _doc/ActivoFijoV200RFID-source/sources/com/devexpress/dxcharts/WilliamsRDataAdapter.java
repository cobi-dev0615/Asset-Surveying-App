...
class WilliamsRDataAdapter extends XYSeriesDataAdapterBase {
    int _pointsCount;
    ...
    public static WilliamsRDataAdapter create(CalculatedSeriesDataWrapper calculatedSeriesDataWrapper, long j, Object obj, int i) {
        WilliamsRDataAdapter williamsRDataAdapter = new WilliamsRDataAdapter(calculatedSeriesDataWrapper, i);
        williamsRDataAdapter.initialize(j);
        williamsRDataAdapter.setSyncObject(obj);
        return williamsRDataAdapter;
    }

    WilliamsRDataAdapter(CalculatedSeriesDataWrapper calculatedSeriesDataWrapper, int i) {
