...
public class RateOfChangeIndicator extends CalculatedSeries {
    ...
    SeriesDataAdapterBase createDataAdapter(XYSeriesData xYSeriesData) {
        ...
        return RateOfChangeDataAdapter.create(new CalculatedSeriesDataWrapper(calculatedSeriesData), getNativeSeries(), getActualValueLevel(this._valueLevel, calculatedSeriesData), getSyncObject(), this._pointsCount);
    }
