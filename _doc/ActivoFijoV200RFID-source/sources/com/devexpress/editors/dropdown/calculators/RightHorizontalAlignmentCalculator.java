...
public final class RightHorizontalAlignmentCalculator implements HorizontalAlignmentCalculator {
    ...
    public Rectangle calcContentFrame(Rectangle currentContentFrame, AlignmentCalculationInfo info) {
        ...
        if (info.getPlacement() == DXPlacement.Right) {
            ...
            rectangle.set(info.getMaxAnchorPoint(), 0, info.getContentSize().getWidth(), 0);
            rectangle2.set(info.getMaxAnchorPoint(), 0, maxAnchorPoint, 0);
            rectangle3.set(info.getMinAnchorPoint() - info.getContentSize().getWidth(), 0, info.getContentSize().getWidth(), 0);
            rectangle4.set(info.getMinAnchorPoint() - right, 0, right, 0);
            ...
            rectangle.set(info.getMaxAnchorPoint() - info.getContentSize().getWidth(), 0, info.getContentSize().getWidth(), 0);
            rectangle2.set(info.getMaxAnchorPoint() - maxAnchorPoint, 0, maxAnchorPoint, 0);
            rectangle3.set(info.getMinAnchorPoint(), 0, info.getContentSize().getWidth(), 0);
            rectangle4.set(info.getMinAnchorPoint(), 0, right, 0);
    ...
    public Rectangle recalcContentFrame(Rectangle currentContentFrame, AlignmentCalculationInfo info) {
        ...
        Intrinsics.checkNotNullParameter(info, "info");
        if (info.getPlacement() == DXPlacement.Right) {
            currentContentFrame.setWidth(Math.min(info.getContentSize().getWidth(), info.getBounds().right() - info.getMaxAnchorPoint()));
        } else {
            currentContentFrame.setWidth(Math.min(info.getContentSize().getWidth(), info.getMaxAnchorPoint() - info.getBounds().getLeft()));
            currentContentFrame.setLeft(info.getMaxAnchorPoint() - currentContentFrame.getWidth());
        }
        return currentContentFrame;
    }
}
