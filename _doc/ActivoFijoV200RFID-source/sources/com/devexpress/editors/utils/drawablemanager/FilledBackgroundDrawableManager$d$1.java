...
public final class FilledBackgroundDrawableManager$d$1 implements AnimationManagerDrawable.Delegate<UnderlinedMaterialRectDrawable> {
    ...
    public ValueAnimator createAnimator(final UnderlinedMaterialRectDrawable managedDrawable, final AnimationManagerDrawable.DrawableParams startParams, final AnimationManagerDrawable.DrawableParams endParams) {
        ...
        ofFloat.addUpdateListener(new ValueAnimator.AnimatorUpdateListener() { // from class: com.devexpress.editors.utils.drawablemanager.FilledBackgroundDrawableManager$d$1$$ExternalSyntheticLambda0
            @Override // android.animation.ValueAnimator.AnimatorUpdateListener
            public final void onAnimationUpdate(ValueAnimator valueAnimator) {
                FilledBackgroundDrawableManager$d$1.createAnimator$lambda$0(UnderlinedMaterialRectDrawable.this, startParams, endParams, valueAnimator);
            }
        });
    ...
    public static final void createAnimator$lambda$0(UnderlinedMaterialRectDrawable managedDrawable, AnimationManagerDrawable.DrawableParams startParams, AnimationManagerDrawable.DrawableParams endParams, ValueAnimator it) {
        Intrinsics.checkNotNullParameter(managedDrawable, "$managedDrawable");
        Intrinsics.checkNotNullParameter(startParams, "$startParams");
        Intrinsics.checkNotNullParameter(endParams, "$endParams");
