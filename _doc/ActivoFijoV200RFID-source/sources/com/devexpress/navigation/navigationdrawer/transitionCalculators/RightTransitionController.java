...
public class RightTransitionController extends BaseTransitionController {
    @Override // com.devexpress.navigation.navigationdrawer.transitionCalculators.BaseTransitionController
    public boolean isHorizontal() {
        return true;
    }

    public RightTransitionController(View view, int i, int i2, Rect rect) {
        super(view, i, i2, rect);
        int i3 = this.mViewPort.right - this.mViewPort.left;
        this.openedViewBounds = new Rect(i3 - this.mViewSize, 0, i3, this.mViewPort.bottom - this.mViewPort.top);
