...
public class GridTextColumnTextAppearance implements GridTextAppearance {
    private TextColumnModelBase gridColumnModel;
    private GridTextAppearance gridTextAppearance;

    public void initialize(GridTextAppearance gridTextAppearance, TextColumnModelBase textColumnModelBase) {
        this.gridTextAppearance = gridTextAppearance;
        this.gridColumnModel = textColumnModelBase;
    }
