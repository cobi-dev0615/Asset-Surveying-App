...
public class DesUtils {
    ...
    public static byte[] encode(String str, byte[] bArr, byte[] bArr2) {
        ...
        try {
            ...
            SecretKeySpec secretKeySpec = new SecretKeySpec(bArr, indexOf > 0 ? str.substring(0, indexOf) : str);
    ...
    public static byte[] decode(String str, byte[] bArr, byte[] bArr2) {
        if (bArr == null || bArr2 == null) {
            throw new IllegalArgumentException();
        }
        if (bArr.length % 8 != 0 || bArr2.length % 8 != 0) {
