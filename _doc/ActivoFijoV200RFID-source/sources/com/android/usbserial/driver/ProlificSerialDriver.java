...
import com.android.usbserial.util.BuildConfig;
...
public class ProlificSerialDriver implements UsbSerialDriver {
    private static final int[] standardBaudRates = {75, 150, 300, 600, 1200, 1800, 2400, 3600, 4800, 7200, 9600, 14400, 19200, 28800, 38400, 57600, 115200, 128000, 134400, 161280, 201600, 230400, 268800, 403200, 460800, 614400, 806400, 921600, 1228800, 2457600, 3000000, GmsVersion.VERSION_MANCHEGO};
    private final String TAG = "ProlificSerialDriver";
    ...
    class ProlificSerialPort extends CommonUsbSerialPort {
        ...
        private byte[] inControlTransfer(int i, int i2, int i3, int i4, int i5) throws IOException {
            ...
            throw new IOException(String.format("ControlTransfer 0x%x failed: %d", Integer.valueOf(i3), Integer.valueOf(controlTransfer)));
        }
        ...
        private byte[] vendorIn(int i, int i2, int i3) throws IOException {
            return inControlTransfer(VENDOR_IN_REQTYPE, this.mDeviceType == DeviceType.DEVICE_TYPE_HXN ? 129 : 1, i, i2, i3);
        }
                ...
                synchronized (this.mReadStatusThreadLock) {
                    if (this.mReadStatusThread == null) {
                        ...
                        if (this.mDeviceType == DeviceType.DEVICE_TYPE_HXN) {
                            ...
                            byte b2 = vendorIn(GET_CONTROL_REQUEST, 0, 1)[0];
                            if ((b2 & 8) == 0) {
                                this.mStatus |= 128;
                            }
                            if ((b2 & 4) == 0) {
                        ...
                        this.mReadStatusThread = new Thread(new Runnable() { // from class: com.android.usbserial.driver.ProlificSerialDriver$ProlificSerialPort$$ExternalSyntheticLambda0
        ...
        private int filterBaudRate(int i) {
            ...
            int i3;
            int i4;
            if (BuildConfig.DEBUG && (1610612736 & i) == 536870912) {
                return i & (-536870913);
            }
            if (i <= 0) {
            ...
            Log.d(ProlificSerialDriver.this.TAG, String.format("baud rate=%d, effective=%d, error=%.1f%%, value=0x%08x, mantissa=%d, exponent=%d", Integer.valueOf(i), Integer.valueOf(i4), Double.valueOf(abs * 100.0d), Integer.valueOf(i3), Integer.valueOf(i6), Integer.valueOf(i2)));
            return i3;
        }
        ...
        public void setParameters(int i, int i2, int i3, int i4) throws IOException {
            ...
            if (this.mBaudRate == filterBaudRate && this.mDataBits == i2 && this.mStopBits == i3 && this.mParity == i4) {
                return;
            }
    ...
    public static Map<Integer, int[]> getSupportedDevices() {
        ...
        linkedHashMap.put(Integer.valueOf(UsbId.VENDOR_PROLIFIC), new int[]{UsbId.PROLIFIC_PL2303, UsbId.PROLIFIC_PL23C3, UsbId.PROLIFIC_PL2303GC, UsbId.PROLIFIC_PL2303GB, UsbId.PROLIFIC_PL2303GT, 9187, 9187, UsbId.PROLIFIC_PL2303GS});
