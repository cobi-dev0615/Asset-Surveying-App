...
public final class UnsignedKt {
    ...
    public static final int m1015uintRemainderJ1ME1BU(int i, int i2) {
        return UInt.m758constructorimpl((int) ((i & 4294967295L) % (i2 & 4294967295L)));
    }

    /* renamed from: uintDivide-J1ME1BU, reason: not valid java name */
    public static final int m1014uintDivideJ1ME1BU(int i, int i2) {
        return UInt.m758constructorimpl((int) ((i & 4294967295L) / (i2 & 4294967295L)));
    }

    /* renamed from: ulongDivide-eb3DHEI, reason: not valid java name */
    public static final long m1016ulongDivideeb3DHEI(long j, long j2) {
        int compare;
        int compare2;
        if (j2 < 0) {
            compare2 = Long.compare(j ^ Long.MIN_VALUE, j2 ^ Long.MIN_VALUE);
            return compare2 < 0 ? ULong.m837constructorimpl(0L) : ULong.m837constructorimpl(1L);
        }
        if (j >= 0) {
            return ULong.m837constructorimpl(j / j2);
        }
        long j3 = ((j >>> 1) / j2) << 1;
        compare = Long.compare(ULong.m837constructorimpl(j - (j3 * j2)) ^ Long.MIN_VALUE, ULong.m837constructorimpl(j2) ^ Long.MIN_VALUE);
        return ULong.m837constructorimpl(j3 + (compare < 0 ? 0 : 1));
    }

    /* renamed from: ulongRemainder-eb3DHEI, reason: not valid java name */
    public static final long m1017ulongRemaindereb3DHEI(long j, long j2) {
        int compare;
        int compare2;
        if (j2 < 0) {
            compare2 = Long.compare(j ^ Long.MIN_VALUE, j2 ^ Long.MIN_VALUE);
            return compare2 < 0 ? j : ULong.m837constructorimpl(j - j2);
        }
        if (j >= 0) {
            return ULong.m837constructorimpl(j % j2);
        }
        long j3 = j - ((((j >>> 1) / j2) << 1) * j2);
        compare = Long.compare(ULong.m837constructorimpl(j3) ^ Long.MIN_VALUE, ULong.m837constructorimpl(j2) ^ Long.MIN_VALUE);
        if (compare < 0) {
            j2 = 0;
        }
        return ULong.m837constructorimpl(j3 - j2);
    }
    ...
    public static final int doubleToUInt(double d) {
        ...
        if (d <= 2.147483647E9d) {
            return UInt.m758constructorimpl((int) d);
        }
        return UInt.m758constructorimpl(UInt.m758constructorimpl((int) (d - Integer.MAX_VALUE)) + UInt.m758constructorimpl(Integer.MAX_VALUE));
    }
    ...
    public static final long doubleToULong(double d) {
        ...
        if (d < 9.223372036854776E18d) {
            return ULong.m837constructorimpl((long) d);
        }
        return ULong.m837constructorimpl(ULong.m837constructorimpl((long) (d - 9.223372036854776E18d)) - Long.MIN_VALUE);
    }
