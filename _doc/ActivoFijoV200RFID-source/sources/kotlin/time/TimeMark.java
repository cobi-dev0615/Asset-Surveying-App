...
public interface TimeMark {
    ...
    TimeMark mo1980minusLRDsOJo(long duration);

    /* renamed from: plus-LRDsOJo */
    TimeMark mo1982plusLRDsOJo(long duration);

    /* compiled from: TimeSource.kt */
    @Metadata(k = 3, mv = {1, 9, 0}, xi = 48)
    public static final class DefaultImpls {
        /* renamed from: plus-LRDsOJo, reason: not valid java name */
        public static TimeMark m2127plusLRDsOJo(TimeMark timeMark, long j) {
            return new AdjustedTimeMark(timeMark, j, null);
        }

        /* renamed from: minus-LRDsOJo, reason: not valid java name */
        public static TimeMark m2126minusLRDsOJo(TimeMark timeMark, long j) {
            return timeMark.mo1982plusLRDsOJo(Duration.m2042unaryMinusUwyO8pc(j));
        }

        public static boolean hasPassedNow(TimeMark timeMark) {
            return !Duration.m2022isNegativeimpl(timeMark.mo1979elapsedNowUwyO8pc());
        }
