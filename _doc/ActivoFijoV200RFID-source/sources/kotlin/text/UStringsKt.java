...
public final class UStringsKt {
    ...
    public static final String m1976toStringLxnNnR4(byte b, int i) {
    ...
    public static final String m1978toStringolVBNx4(short s, int i) {
    ...
    public static final String m1977toStringV7xB4Y4(int i, int i2) {
        return UnsignedKt.ulongToString(i & 4294967295L, CharsKt.checkRadix(i2));
    }

    /* renamed from: toString-JSWoG40, reason: not valid java name */
    public static final String m1975toStringJSWoG40(long j, int i) {
    ...
    public static final UByte toUByteOrNull(String str, int i) {
        ...
        compare = Integer.compare(data ^ Integer.MIN_VALUE, UInt.m758constructorimpl(255) ^ Integer.MIN_VALUE);
        if (compare > 0) {
            return null;
        }
        return UByte.m673boximpl(UByte.m679constructorimpl((byte) data));
    }
    ...
    public static final UShort toUShortOrNull(String str, int i) {
        ...
        int data = uIntOrNull.getData();
        compare = Integer.compare(data ^ Integer.MIN_VALUE, UInt.m758constructorimpl(65535) ^ Integer.MIN_VALUE);
        if (compare > 0) {
            return null;
        }
        return UShort.m938boximpl(UShort.m944constructorimpl((short) data));
    }
    ...
    public static final UInt toUIntOrNull(String str, int i) {
        ...
        int m758constructorimpl = UInt.m758constructorimpl(i);
        int i4 = 119304647;
        while (i2 < length) {
            ...
            if (compare > 0) {
                if (i4 == 119304647) {
                    i4 = UByte$$ExternalSyntheticBackport0.m(-1, m758constructorimpl);
            ...
            int m758constructorimpl2 = UInt.m758constructorimpl(i3 * m758constructorimpl);
            int m758constructorimpl3 = UInt.m758constructorimpl(UInt.m758constructorimpl(digitOf) + m758constructorimpl2);
            compare2 = Integer.compare(m758constructorimpl3 ^ Integer.MIN_VALUE, m758constructorimpl2 ^ Integer.MIN_VALUE);
            if (compare2 < 0) {
                return null;
            }
            i2++;
            i3 = m758constructorimpl3;
        }
        return UInt.m752boximpl(i3);
    }
    ...
    public static final ULong toULongOrNull(String str, int i) {
        ...
        long m837constructorimpl = ULong.m837constructorimpl(i);
        long j = 0;
        ...
        while (i2 < length) {
            ...
            if (compare > 0) {
                if (j2 == 512409557603043100L) {
                    j2 = UByte$$ExternalSyntheticBackport0.m$1(-1L, m837constructorimpl);
            ...
            long m837constructorimpl2 = ULong.m837constructorimpl(j * m837constructorimpl);
            long m837constructorimpl3 = ULong.m837constructorimpl(ULong.m837constructorimpl(UInt.m758constructorimpl(r13) & 4294967295L) + m837constructorimpl2);
            compare2 = Long.compare(m837constructorimpl3 ^ Long.MIN_VALUE, m837constructorimpl2 ^ Long.MIN_VALUE);
            if (compare2 < 0) {
                return null;
            }
            i2++;
            j = m837constructorimpl3;
        }
        return ULong.m831boximpl(j);
    }
}
