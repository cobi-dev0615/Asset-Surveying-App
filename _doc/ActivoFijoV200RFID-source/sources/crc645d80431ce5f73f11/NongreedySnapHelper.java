...
public abstract class NongreedySnapHelper extends LinearSnapHelper implements IGCUserPeer {
    ...
    static {
        Runtime.register("Microsoft.Maui.Controls.Handlers.Items.NongreedySnapHelper, Microsoft.Maui.Controls", NongreedySnapHelper.class, __md_methods);
    }

    public NongreedySnapHelper() {
        if (getClass() == NongreedySnapHelper.class) {
            TypeManager.Activate("Microsoft.Maui.Controls.Handlers.Items.NongreedySnapHelper, Microsoft.Maui.Controls", "", this, new Object[0]);
        }
    }
