...
public class EmptyViewAdapter extends RecyclerView.Adapter implements IGCUserPeer {
    ...
    static {
        Runtime.register("Microsoft.Maui.Controls.Handlers.Items.EmptyViewAdapter, Microsoft.Maui.Controls", EmptyViewAdapter.class, __md_methods);
    }

    public EmptyViewAdapter() {
        if (getClass() == EmptyViewAdapter.class) {
            TypeManager.Activate("Microsoft.Maui.Controls.Handlers.Items.EmptyViewAdapter, Microsoft.Maui.Controls", "", this, new Object[0]);
        }
    }
