...
public class ListViewRenderer_ListViewScrollDetector implements IGCUserPeer, AbsListView.OnScrollListener {
    ...
    static {
        Runtime.register("Microsoft.Maui.Controls.Handlers.Compatibility.ListViewRenderer+ListViewScrollDetector, Microsoft.Maui.Controls", ListViewRenderer_ListViewScrollDetector.class, "n_onScroll:(Landroid/widget/AbsListView;III)V:GetOnScroll_Landroid_widget_AbsListView_IIIHandler:Android.Widget.AbsListView/IOnScrollListenerInvoker, Mono.Android, Version=0.0.0.0, Culture=neutral, PublicKeyToken=null\nn_onScrollStateChanged:(Landroid/widget/AbsListView;I)V:GetOnScrollStateChanged_Landroid_widget_AbsListView_IHandler:Android.Widget.AbsListView/IOnScrollListenerInvoker, Mono.Android, Version=0.0.0.0, Culture=neutral, PublicKeyToken=null\n");
    }

    public ListViewRenderer_ListViewScrollDetector() {
        if (getClass() == ListViewRenderer_ListViewScrollDetector.class) {
            TypeManager.Activate("Microsoft.Maui.Controls.Handlers.Compatibility.ListViewRenderer+ListViewScrollDetector, Microsoft.Maui.Controls", "", this, new Object[0]);
        }
    }

    public ListViewRenderer_ListViewScrollDetector(ListViewRenderer listViewRenderer) {
        if (getClass() == ListViewRenderer_ListViewScrollDetector.class) {
            TypeManager.Activate("Microsoft.Maui.Controls.Handlers.Compatibility.ListViewRenderer+ListViewScrollDetector, Microsoft.Maui.Controls", "Microsoft.Maui.Controls.Handlers.Compatibility.ListViewRenderer, Microsoft.Maui.Controls", this, new Object[]{listViewRenderer});
        }
    }
