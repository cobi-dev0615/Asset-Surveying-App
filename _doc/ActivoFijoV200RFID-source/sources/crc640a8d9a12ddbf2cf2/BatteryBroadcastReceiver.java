...
public class BatteryBroadcastReceiver extends BroadcastReceiver implements IGCUserPeer {
    ...
    static {
        Runtime.register("Microsoft.Maui.Devices.BatteryBroadcastReceiver, Microsoft.Maui.Essentials", BatteryBroadcastReceiver.class, "n_onReceive:(Landroid/content/Context;Landroid/content/Intent;)V:GetOnReceive_Landroid_content_Context_Landroid_content_Intent_Handler\n");
    }

    public BatteryBroadcastReceiver() {
        if (getClass() == BatteryBroadcastReceiver.class) {
            TypeManager.Activate("Microsoft.Maui.Devices.BatteryBroadcastReceiver, Microsoft.Maui.Essentials", "", this, new Object[0]);
        }
    }
