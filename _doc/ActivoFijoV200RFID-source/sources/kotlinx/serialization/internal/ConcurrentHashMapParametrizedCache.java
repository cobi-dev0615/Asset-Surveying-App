...
final class ConcurrentHashMapParametrizedCache<T> implements ParametrizedSerializerCache<T> {
    ...
    public Object mo2256getgIAlus(KClass<Object> key, List<? extends KType> types) {
        ...
        if (obj == null) {
            try {
                ...
                m661constructorimpl = Result.m661constructorimpl(this.compute.invoke(key, types));
            } catch (Throwable th) {
            ...
            Object putIfAbsent2 = concurrentHashMap2.putIfAbsent(arrayList2, m660boximpl);
            obj = putIfAbsent2 == null ? m660boximpl : putIfAbsent2;
        }
