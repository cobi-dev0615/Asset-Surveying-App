...
public final class DelayKt {
    ...
    */
    ...
    public static final Object delay(long j, Continuation<? super Unit> continuation) {
        ...
        if (j < Long.MAX_VALUE) {
            getDelay(cancellableContinuationImpl2.getContext()).mo2236scheduleResumeAfterDelay(j, cancellableContinuationImpl2);
        }
    ...
    public static final Object m2157delayVtjQ1oo(long j, Continuation<? super Unit> continuation) {
        Object delay = delay(m2158toDelayMillisLRDsOJo(j), continuation);
    ...
    public static final long m2158toDelayMillisLRDsOJo(long j) {
        boolean m2023isPositiveimpl = Duration.m2023isPositiveimpl(j);
        if (m2023isPositiveimpl) {
            Duration.Companion companion = Duration.INSTANCE;
            return Duration.m2007getInWholeMillisecondsimpl(Duration.m2025plusLRDsOJo(j, DurationKt.toDuration(999999L, DurationUnit.NANOSECONDS)));
        }
        if (m2023isPositiveimpl) {
