...
@DebugMetadata(c = "kotlinx.coroutines.channels.ChannelsKt__DeprecatedKt$filter$1", f = "Deprecated.kt", i = {0, 1, 1, 2}, l = {EnumG.BaseMid_SetGJbBaseband, EnumG.BaseMid_GetGJbBaseband, EnumG.BaseMid_GetGJbBaseband}, m = "invokeSuspend", n = {"$this$produce", "$this$produce", "e", "$this$produce"}, s = {"L$0", "L$0", "L$2", "L$0"})
