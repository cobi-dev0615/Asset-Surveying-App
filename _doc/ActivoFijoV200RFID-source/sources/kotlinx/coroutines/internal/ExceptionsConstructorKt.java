...
public final class ExceptionsConstructorKt {
    ...
    public static final <E extends Throwable> E tryCopyException(E e) {
        ...
        if (e instanceof CopyableThrowable) {
            try {
                ...
                m661constructorimpl = Result.m661constructorimpl(((CopyableThrowable) e).createCopy());
            } catch (Throwable th) {
            ...
            if (Result.m667isFailureimpl(m661constructorimpl)) {
                m661constructorimpl = null;
            }
            return (E) m661constructorimpl;
        }
    ...
    public static final Throwable safeCtor$lambda$9(Function1 function1, Throwable th) {
        ...
        try {
            ...
            m661constructorimpl = Result.m661constructorimpl(th2);
        } catch (Throwable th3) {
            Result.Companion companion2 = Result.INSTANCE;
            m661constructorimpl = Result.m661constructorimpl(ResultKt.createFailure(th3));
        }
        return (Throwable) (Result.m667isFailureimpl(m661constructorimpl) ? null : m661constructorimpl);
    }
    ...
    private static final int fieldsCountOrDefault(Class<?> cls, int i) {
        ...
        try {
            Result.Companion companion = Result.INSTANCE;
            m661constructorimpl = Result.m661constructorimpl(Integer.valueOf(fieldsCount$default(cls, 0, 1, null)));
        } catch (Throwable th) {
            Result.Companion companion2 = Result.INSTANCE;
            m661constructorimpl = Result.m661constructorimpl(ResultKt.createFailure(th));
        }
        ...
        if (Result.m667isFailureimpl(m661constructorimpl)) {
            m661constructorimpl = valueOf;
        }
        return ((Number) m661constructorimpl).intValue();
    }
