...
public final class CompletionStateKt {
    public static final <T> Object toState(Object obj) {
        ...
        return m664exceptionOrNullimpl == null ? obj : new CompletedExceptionally(m664exceptionOrNullimpl, false, 2, null);
    }
        ...
        if (m664exceptionOrNullimpl != null) {
            if (DebugKt.getRECOVER_STACK_TRACES()) {
                ...
                if (cancellableContinuation2 instanceof CoroutineStackFrame) {
                    m664exceptionOrNullimpl = StackTraceRecoveryKt.recoverFromStackFrame(m664exceptionOrNullimpl, (CoroutineStackFrame) cancellableContinuation2);
                }
            }
            obj = new CompletedExceptionally(m664exceptionOrNullimpl, false, 2, null);
        }
        return obj;
    }
    ...
    public static final <T> Object recoverResult(Object obj, Continuation<? super T> continuation) {
        if (obj instanceof CompletedExceptionally) {
            ...
            return Result.m661constructorimpl(ResultKt.createFailure(th));
        }
