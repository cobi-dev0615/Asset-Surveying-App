...
public class ShellFlyoutRecyclerAdapter extends RecyclerView.Adapter implements IGCUserPeer {
    ...
    static {
        Runtime.register("Microsoft.Maui.Controls.Platform.Compatibility.ShellFlyoutRecyclerAdapter, Microsoft.Maui.Controls", ShellFlyoutRecyclerAdapter.class, __md_methods);
    }

    public ShellFlyoutRecyclerAdapter() {
        if (getClass() == ShellFlyoutRecyclerAdapter.class) {
            TypeManager.Activate("Microsoft.Maui.Controls.Platform.Compatibility.ShellFlyoutRecyclerAdapter, Microsoft.Maui.Controls", "", this, new Object[0]);
        }
    }
