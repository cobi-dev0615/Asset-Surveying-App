...
public class ShellToolbarTracker implements IGCUserPeer, View.OnClickListener {
    ...
    static {
        Runtime.register("Microsoft.Maui.Controls.Platform.Compatibility.ShellToolbarTracker, Microsoft.Maui.Controls", ShellToolbarTracker.class, "n_onClick:(Landroid/view/View;)V:GetOnClick_Landroid_view_View_Handler:Android.Views.View/IOnClickListenerInvoker, Mono.Android, Version=0.0.0.0, Culture=neutral, PublicKeyToken=null\n");
    }

    public ShellToolbarTracker() {
        if (getClass() == ShellToolbarTracker.class) {
            TypeManager.Activate("Microsoft.Maui.Controls.Platform.Compatibility.ShellToolbarTracker, Microsoft.Maui.Controls", "", this, new Object[0]);
        }
    }
