...
public class InnerScaleListener extends ScaleGestureDetector.SimpleOnScaleGestureListener implements IGCUserPeer {
    ...
    static {
        Runtime.register("Microsoft.Maui.Controls.Platform.InnerScaleListener, Microsoft.Maui.Controls", InnerScaleListener.class, __md_methods);
    }

    public InnerScaleListener() {
        if (getClass() == InnerScaleListener.class) {
            TypeManager.Activate("Microsoft.Maui.Controls.Platform.InnerScaleListener, Microsoft.Maui.Controls", "", this, new Object[0]);
        }
    }
