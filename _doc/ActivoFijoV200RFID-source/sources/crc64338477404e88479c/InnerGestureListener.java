...
public class InnerGestureListener implements IGCUserPeer, GestureDetector.OnGestureListener, GestureDetector.OnDoubleTapListener {
    ...
    static {
        Runtime.register("Microsoft.Maui.Controls.Platform.InnerGestureListener, Microsoft.Maui.Controls", InnerGestureListener.class, __md_methods);
    }

    public InnerGestureListener() {
        if (getClass() == InnerGestureListener.class) {
            TypeManager.Activate("Microsoft.Maui.Controls.Platform.InnerGestureListener, Microsoft.Maui.Controls", "", this, new Object[0]);
        }
    }
