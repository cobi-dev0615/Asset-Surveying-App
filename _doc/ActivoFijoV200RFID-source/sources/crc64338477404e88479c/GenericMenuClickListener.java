...
public class GenericMenuClickListener implements IGCUserPeer, MenuItem.OnMenuItemClickListener {
    ...
    static {
        Runtime.register("Microsoft.Maui.Controls.Platform.GenericMenuClickListener, Microsoft.Maui.Controls", GenericMenuClickListener.class, "n_onMenuItemClick:(Landroid/view/MenuItem;)Z:GetOnMenuItemClick_Landroid_view_MenuItem_Handler:Android.Views.IMenuItemOnMenuItemClickListenerInvoker, Mono.Android, Version=0.0.0.0, Culture=neutral, PublicKeyToken=null\n");
    }

    public GenericMenuClickListener() {
        if (getClass() == GenericMenuClickListener.class) {
            TypeManager.Activate("Microsoft.Maui.Controls.Platform.GenericMenuClickListener, Microsoft.Maui.Controls", "", this, new Object[0]);
        }
    }
