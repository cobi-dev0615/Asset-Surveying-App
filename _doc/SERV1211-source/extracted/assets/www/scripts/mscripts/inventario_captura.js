...
function consultaArrayDatos(strArray) {
    try {
        ...
        lectura = lecturaArray[0].toString().trim();
        var lote = lecturaArray[1].toString().trim();
        cantidadFactorSeleccionado = Number(lecturaArray[2].toString()) || 1;
        fechaElaboracionSeleccionado = lecturaArray[3].toString().trim();
